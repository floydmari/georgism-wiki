---
title: "With Liberty and Dividends for All: How to Save Our Middle Class When Jobs Don't Pay Enough"
category: books
tags: [research, books-publications, dividends, co-owned-wealth, middle-class, inequality, rent-capture, alaska-model, peter-barnes]
...
4. Distribute revenue as equal per-capita dividends to all legal residents ("one person, one share")
5. Implement via electronic dividend transfers, not government programs
6. No new taxes required — the dividends come from legitimate property income from co-owned wealth
...
- [Alaska Permanent Fund](/wiki/alaska-permanent-fund/) — the working model Barnes examines
- Co-owned Wealth — the concept of shared inheritance
- [Resource Rent](/wiki/resource-rents/) — the rent capture framework
- [Henry George](/wiki/henry-george/) — cited as intellectual predecessor
- [Capitalism 3.0](/wiki/capitalism-3-0/) — Barnes's earlier work developing the same ideas
- Carbon Dividends — the atmosphere as co-owned asset
- [Thomas Paine](/wiki/thomas-paine/) — cited for 1797 proposal

## See Also

- [Capitalism 3.0](/wiki/capitalism-3-0/)
- Universal Dividend
