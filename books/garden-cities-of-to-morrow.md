...
1. Ebenezer Howard, *Garden Cities of To-morrow* (London: Swan Sonnenschein & Co., 1902). — used for all claims on this page (primary source); verified against primary text 2026-07-07 (Scan Depth: Moderate). PUBLIC DOMAIN (pre-1929). **Complete text held in this repository:** [`sources/publicdomain/garden-cities-of-to-morrow.md`](../sources/publicdomain/garden-cities-of-to-morrow.md) (transcribed from [Project Gutenberg #46134](https://www.gutenberg.org/cache/epub/46134/pg46134.txt), fetched 2026-07-11; Gutenberg boilerplate stripped top and bottom, no modernization — see EDITORIAL §3b).
