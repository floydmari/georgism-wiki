...
3. **Land value can be accurately assessed** — modern mass appraisal methods can separate land value from improvement value with sufficient accuracy for practical policy
...
- All government (federal + state + local): land rents cover 14–49%
- **Billionaire comparison:** Expropriating 100% of all 745 US billionaires' wealth yields a one-time ~$5T; land rents raise $1.2–3.5T *every year*, and land cannot flee (Ch. 15)
...
8. Open real estate transaction data — push for public records and open-source mass appraisal tools
...
1. **Land value estimates are contested:** The $24T–$44T range reflects genuine methodological disagreement
2. **ATCOR is a hypothesis, not a proven theorem:** Doucet calls for empirical testing
3. **No case studies in first edition:** Pittsburgh is referenced (Bourassa 1987) but Detroit, England, Norway case studies are deferred to future editions
4. **The book is advocacy, not neutral:** Doucet is a self-identified Georgist
5. **Page count not confirmed from EPUB:** Approximately 400 pages based on content scope
6. **Publisher discrepancy:** Some sources list "Center for Land Governance" but the EPUB copyright page explicitly names Shack Simple Press
