...
4. Henry George (1879), *Progress and Poverty*, Book VII, Ch. III ("Claim of Land Owners to Compensation") — used for George's own attributed argument against compensating existing landowners, contrasted with Mill's compensation-based, future-increment-only design (D-claim; quotation verified verbatim, public domain). **Complete text hosted on this wiki:** [Progress and Poverty — full text](/wiki/progress-and-poverty-full-text/). Georgist-lens summary: [Progress and Poverty](/wiki/progress-and-poverty/). Mill's contrasting design: [Mill's Land Program](/wiki/mill-principles-land/).
