...
- This page relies on one historian's synthesis (Blaug, writing more than a century after the fact); it has not been cross-checked here against a primary marginalist source disputing the framing. [CITATION NEEDED: an independent history-of-thought source corroborating or contesting the "thirty years out of date" characterization.]
- A closely related but distinct historical exchange from the same Blaug chapter is [Alfred Marshall](/wiki/alfred-marshall/)'s objection that all factors, not just land, earn short-run "rents" — a separate line of critique from the "outdated" charge treated here.
...
- [Progress and Poverty](/wiki/progress-and-poverty/) — the book under judgment
- [Henry George](/wiki/henry-george/) — its author
