...
1. Hulseman, Rovang, Bales & Nguyen (2019), "Land Value Tax Analysis: Simulating the Tax in Multnomah County," Northwest Economic Research Center, Portland State University — used, via the Economic Possibility Lab's secondary summary of this report, for the Hawaii/Waikiki overdevelopment claim and the Estonia/Queensland exemption examples (C-claim; not independently re-verified against the primary PDF this session, which returned an access error on the direct download). [Economic Possibility Lab summary](https://www.economicpossibility.org/reports/land-value-tax) · [PDXScholar record](https://pdxscholar.library.pdx.edu/nerc_pub/36/)
