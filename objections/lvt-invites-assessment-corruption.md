---
title: "\"LVT Enables Corrupt Assessors and Will Be Gamed\""
category: objections
tags: [objections, assessment, corruption, public-choice, lvt, political-economy]
stub: false
...
A related institutional-design tension shows up outside corruption specifically: [Duflo, Hanna, Olken & Tandon's Chennai experiment](/wiki/duflo-hanna-olken-tandon-chennai-outsourcing/) found that the same anti-corruption procurement rule Cook County lacked — no bureaucratic discretion to favor higher-quality, higher-priced bidders over the lowest bid — produced a *different* failure mode when the government outsourced assessment to private firms: it drove away the more competent contractors, leaving less skilled and less experienced private workers to do the reassessing, who then underperformed government inspectors on both revenue raised and independently verified accuracy. Anti-discretion rules that guard against one failure mode (bribery, favoritism) can create another (adverse selection among contractors) — a reminder that "reduce discretion" is not a costless fix.
...
- [Land value can't be assessed accurately](/wiki/land-cannot-be-assessed/) — the companion technical-assessability objection this page is deliberately distinct from
- [Public Choice Critique](/wiki/public-choice-critique/) — the broader argument that a capturable government lever is dangerous regardless of the base's efficiency
- [Mass Appraisal Methods (CAMA, Hedonic Regression, Land/Building Separation)](/wiki/mass-appraisal-methods/) — the transparency-and-standardization response
- [Ted Gwartney](/wiki/ted-gwartney/) — career assessor whose practice is cited as counter-evidence on the technical side of assessment
- [Does Georgism Work? (Doucet, ACX series)](/wiki/doucet-does-georgism-work/) · [Land is a Big Deal](/wiki/land-is-a-big-deal/) — the source of this page's steelman and response
- [Duflo, Hanna, Olken & Tandon: Chennai Property Tax Outsourcing](/wiki/duflo-hanna-olken-tandon-chennai-outsourcing/) — a case where a discretion-limiting procurement rule produced adverse selection among contractors instead of preventing corruption

## Sources

1. U.S. Department of Justice, U.S. Attorney's Office, Northern District of Illinois, "Three Charged With Participating in Cook County Property Tax Bribery Scheme," press release, 2023. [justice.gov](https://www.justice.gov/usao-ndil/pr/three-charged-participating-cook-county-property-tax-bribery-scheme) — used for the steelman: documented, prosecuted bribery of property-tax assessment officials.
2. ProPublica Illinois, "How the Cook County Assessor Failed Taxpayers," investigative report. [propublica.org](https://features.propublica.org/the-tax-divide/cook-county-commercial-and-industrial-property-tax-assessments/) — used for the systemic-underassessment pattern (as opposed to one-off bribery) and its regressive effect on the tax burden.
3. Lars Doucet, "Does Georgism Work, Part 3: Can Unimproved Land Value Be Accurately Assessed Separately From Buildings?", *Astral Codex Ten*, 2022 — the freely accessible essay this page's response section quotes verbatim (all quotes ≤50 words, checked against the article text, 2026-07-12); expanded into Ch. 26 of [*Land is a Big Deal*](/wiki/land-is-a-big-deal/) (First Edition, Shack Simple Press, 2022), where the same "LVT enables corrupt assessors" objection is addressed in the book's concluding "Moving Forward" material. [astralcodexten.com](https://www.astralcodexten.com/p/does-georgism-work-part-3-can-unimproved)
