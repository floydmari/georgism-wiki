...
- [A Distributional Analysis of a National Guaranteed Basic Income (PBO)](/wiki/pbo-guaranteed-basic-income-costing/)
- [The Town with No Poverty: Forget on Manitoba's Mincome Experiment](/wiki/forget-mincome-town-with-no-poverty/)
...
1. David A. Green, Jonathan Rhys Kesselman & Lindsay M. Tedds (2020), *Covering All the Basics: Reforms for a More Just Society*, Final Report of the BC Expert Panel on Basic Income. [PDF](https://bcbasicincomepanel.ca/wp-content/uploads/2021/01/Final_Report_BC_Basic_Income_Panel.pdf) — used for the steelman: the $51B-vs-$7.5B simulation comparison, the 8,000-vs-44,000 poverty-reduction-per-billion figures, the welfare-wall finding, and the financing analysis.
2. Yuen Pau Woo, "The basic income study that wasn't," *Georgia Straight* (2021). [thestraight.com](https://www.straight.com/news/yuen-pau-woo-basic-income-study-that-wasnt) — used for the fixed-budget framing critique in Response 1.
...
7. Edouard Imbeau (2018), *Take-up rate of the Guaranteed Income Supplement: findings from tax and program administrative data*, Employment and Social Development Canada, Evaluation Directorate. [canada.ca](https://www.canada.ca/en/employment-social-development/services/pension/reports/take-up-rate-gis.html) — used for the quantified Canadian take-up-loss estimate in Response 2 (89.8% take-up in 2015, ~240,000 eligible seniors not receiving GIS).
8. Jennifer Robson & Saul Schwartz (2020), "Who Doesn't File a Tax Return? A Portrait of Non-Filers," *Canadian Public Policy*, 46(3): 323–339. [DOI: 10.3138/cpp.2019-063](https://doi.org/10.3138/cpp.2019-063) — used for the quantified Canadian take-up/non-filing estimate in Response 2 (10–12% non-filing rate; $1.7 billion in forgone cash benefits to working-age non-filers, 2015).