...
- **Phillip J. Anderson** — *The Secret Life of Real Estate and Banking* (2008) added the banking-credit mechanism: the cycle is driven by the capitalization of ground rent through the banking system, not by banking itself.
- **Akhil Patel** — *The Secret Wealth Advantage* (2023) synthesizes the lineage into a practical investment framework.
...
- [18-Year Land Cycle](/wiki/18-year-land-cycle/) — the cycle theory
...
- [Citizen's Dividend](/wiki/citizens-dividend/) — the concept citdiv.org promotes
...
5. [Citizen's Dividend (citdiv.org)](https://citdiv.org/) — Anderson's advocacy microsite; homepage and eBook page for the *Your Citizen's Dividend* program description — used for the "Citizen's Dividend (citdiv.org)" section above (founding date, program description, and quoted framing).
...
8. [PSE: Citizen's Dividend page](https://realestate.propertysharemarketeconomics.com/citizens-dividend-property-share-market-economics/) — eBook description and Crown Estate reference — used for the Crown Estate quotation and the eBook's cover-title/strapline details in the "Citizen's Dividend (citdiv.org)" section above.
