...
category: people
tags: [people, friedrich-hayek, austrian-economics, critique, single-tax, calculation-problem]
stub: false
born: 1899
died: 1992
...
This is an **assessment/calculation objection** — structurally similar to, but narrower than, Rothbard's combined economic-and-moral case against George (see the [Austrian critique objection page](/wiki/lvt-austrian-critique/)). Hayek's argument does not invoke homesteading rights or reject land's common-property status; it turns entirely on whether site value can be measured independently of what has been built on it. He also worried that long-term, freely transferable leases under a land-nationalization scheme "would have to become little different from private property, and all the problems of individual property would reappear" — an argument that the single tax's practical operation would resemble ordinary private tenure more than its advocates suppose.[1]
...
Some secondary Georgist sources — reportedly including Lars A. Doucet's *Land is a Big Deal* — state that Hayek numbered among readers who described their first encounter with George's *Progress and Poverty* as formative, alongside George Bernard Shaw and H.G. Wells. Wikipedia's *Progress and Poverty* article repeats this claim about Hayek, but its footnote at that point cites only H.G. Wells's autobiography, not any Hayek source. Hayek's early reaction to George's book is therefore unconfirmed, and is recorded here as such rather than as established.

## See Also

- [Objection: the Austrian critique of LVT](/wiki/lvt-austrian-critique/) — the broader Austrian-school case, built primarily on Rothbard
- [Murray Rothbard](/wiki/murray-rothbard/) — the Austrian economist whose critique of George is more extensive than Hayek's
- [Ricardo's Law (book)](/wiki/harrison-ricardos-law/) — Harrison's direct engagement with Hayek's argument
- [Radical Markets (book)](/wiki/posner-weyl-radical-markets/) — a later liberal-economics descendant of George's proposal that echoes Hayek's assessment worry
- [Land Value Tax](/wiki/land-value-tax/) · [Geolibertarianism](/wiki/geolibertarianism/)

## Sources

1. F.A. Hayek, *The Constitution of Liberty: The Definitive Edition*, ed. Ronald Hamowy (University of Chicago Press, 1960/2011), Ch. 22 "Housing and Town Planning," pp. 490–491. [Full text, Internet Archive](https://ia800805.us.archive.org/35/items/TheConstitutionOfLiberty/The%20Constitution%20of%20Liberty.pdf) — used for the direct quotations and the description of Hayek's assessment-based rejection of the single tax; text located and verified by direct search of the PDF (2026-07-12). Page numbers are to this definitive 2011 edition and may differ from the original 1960 edition's pagination.
2. Fred Harrison, *Ricardo's Law: House Prices and the Great Tax Clawback Scam* (Shepheard-Walwyn, 2006), Ch. 14.2–14.4, pp. 351–354 (pagination as given in the edition summarized on the wiki's book page). [Wiki summary](/wiki/harrison-ricardos-law/) — used for the "conflated land with capital" characterization of Hayek's position, attributed to Harrison rather than stated as wiki-voice fact.
3. Eric A. Posner & E. Glen Weyl, *Radical Markets: Uprooting Capitalism and Democracy for a Just Society* (Princeton University Press, 2018), Ch. 1, pp. 44–45. [Wiki summary](/wiki/posner-weyl-radical-markets/) — used for the parallel "administrative difficulty" objection to George's land/structure distinction.
