...
Joseph Stiglitz (b. 1943) is an American economist, winner of the 2001 Nobel Memorial Prize (shared with George Akerlof and Michael Spence, for analyses of markets with asymmetric information), and former Chief Economist of the World Bank (1997–2000).[7] Though not a self-described Georgist, his work provides some of the strongest mainstream theoretical support for land value taxation, and it spans from the theorem's original 1977 formalization to a live 2017 extension of the same rent-based logic to artificial intelligence.
...
In a 2017 NBER working paper with **Anton Korinek**, "Artificial Intelligence and Its Implications for Income Distribution and Unemployment," Stiglitz applies the same fixed-factor-rent logic that underlies the Henry George Theorem to a very different asset: AI-driven innovation.[4] The paper decomposes AI's distributional effect into innovator surplus and factor-price effects, arguing that where entry into innovation is restricted the innovator's surplus becomes **"innovator rents"** — "payoffs in excess of the cost of their innovative activity" — and that "under plausible conditions, non-distortionary taxation can be levied to compensate those who otherwise might lose."[4] This is the wiki's clearest case of a Nobel-laureate co-author explicitly carrying Georgist-structured reasoning (tax the rent on a fixed, non-reproducible factor; leave the return that induces genuine activity alone) to the frontier of the AI-rent debate — one of the steepest, most contested points on the wiki's [rent gradient](/wiki/geoism/), since separating genuine innovation reward from rent is far more contested for AI than for land.

## Contemporary Advocacy

Stiglitz has continued to argue that taxing land and rents — rather than labour and
...
targets rent-seeking as a central economic problem.[5] In his inequality work
...
[capital-share outcome](/wiki/capital-share-rise-is-land/) tests empirically.[6]

## How the Wiki Uses Him

Stiglitz is the wiki's clearest case of **mainstream theoretical validation**: the
[Henry George Theorem](/wiki/henry-george-theorem/) he formalized anchors the
[public-goods outcome](/wiki/public-goods-fundable-from-land-rent/), and
[Doucet's synthesis](/wiki/land-is-a-big-deal/) places him in the
Smith → Ricardo → George lineage (Ch. 15). Honest limits: he endorses rent
taxation *within* a broader progressive program, not the single tax; and the HGT
holds under idealized conditions its own literature qualifies
([Arnott's practical guide](/wiki/arnott-hgt-practical-guide/);
[Behrens on second-best](/wiki/behrens-hgt-second-best/)).
...
- [Albouy et al. (2019), What Are Cities Worth?](/wiki/albouy-what-are-cities-worth/) — credits Stiglitz's theorem, alongside Vickrey (1977) and Arnott & Stiglitz (1979), as one of the HGT's three founding statements
- [William Vickrey](/wiki/william-vickrey/) — the other Nobel-tier public economist in the wiki's orbit, and a co-founder of the same HGT literature

## Sources

1. Joseph E. Stiglitz (1977), "The Theory of Local Public Goods," in *The Economics of Public Services* (Macmillan) — used for the HGT coinage and the original capitalization result (A/C-claims), via the wiki's [research page](/wiki/stiglitz-theory-local-public-goods/).
2. Arnott & Stiglitz (1979), "Aggregate Land Rents, Expenditure on Public Goods, and Optimal City Size," *QJE* — used for the contemporaneous general-equilibrium formalization (A/C-claims). [wiki summary](/wiki/arnott-stiglitz-henry-george-theorem/)
3. Damien Albouy, Kristian Behrens, Frédéric Robert-Nicoud & Nathan Seegert (2019), "The Optimal Distribution of Population across Cities," *Journal of Urban Economics* — used for the direct quotation naming Vickrey (1977), Stiglitz's work, and Arnott & Stiglitz (1979) as the theorem's three founding statements, and for the heterogeneous-sites breakdown result (A/C-claim), via the wiki's [research page](/wiki/albouy-what-are-cities-worth/).
4. Anton Korinek & Joseph E. Stiglitz (2017), "Artificial Intelligence and Its Implications for Income Distribution and Unemployment," NBER Working Paper 24174 — used for the innovator-rents framework and the non-distortionary-taxation quotation (A/C-claims), via the wiki's [research page](/wiki/korinek-stiglitz-ai-rents/). [NBER](https://www.nber.org/system/files/working_papers/w24174/w24174.pdf)
