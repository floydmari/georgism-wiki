...
stub: false
excerpt: "Goldsmith's 2002 BIEN paper reviews 20 years of the Alaska Permanent Fund Dividend and reports it cut Alaska poverty by an estimated 20-40% and rural Indigenous poverty from about 28% to 22%, with no serious political proposal to end it."
...
- **Outcome:** [Resource-rent dividends are workable and durable](/wiki/resource-rent-dividends-work/) — an early (two-decades-in), independently authored assessment reporting concrete poverty-reduction and political-durability findings, corroborating the outcome's core claim from a source that predates the wiki's existing book-length treatment of the same case.
- **Event:** [Establishment of the Alaska Permanent Fund](/wiki/alaska-permanent-fund/) — direct evidence of the Fund/Dividend's early social and political impact.
- **Concept:** [Citizen's Dividend](/wiki/citizens-dividend/) — supplies concrete distributional evidence (poverty reduction, progressivity of a flat per-capita payment) for the concept's real-world track record.
- **Concept:** [Resource Rents](/wiki/resource-rents/) — a case study in resource rent captured and distributed as a citizen's dividend.
...
1. Scott Goldsmith (2002), "The Alaska Permanent Fund Dividend: An Experiment in Wealth Distribution," paper prepared for the 9th International Congress of the Basic Income European Network (BIEN), Geneva, Switzerland, September 2002. [BIEN PDF](https://basicincome.org/bien/pdf/2002Goldsmith.pdf) — used for the paper's core findings on poverty reduction, distributional design, and political durability.
2. Institute of Social and Economic Research (ISER), University of Alaska Anchorage — legacy publication archive listing of the same paper. [ISER PDF](https://iseralaska.org/static/legacy_publication_links/bien_xiii_ak_pfd_lessons.pdf) — used as a corroborating independent host confirming the paper's existence, title, and author.
3. ScholarWorks @ University of Alaska, item record for "The Alaska Permanent Fund Dividend: An Experiment in Wealth Distribution." [ScholarWorks](https://scholarworks.alaska.edu/handle/11122/14552) — used as a corroborating bibliographic record.
4. International Labour Organization (ILO), Social Security Extension mirror of the same paper. [ILO PDF](https://webapps.ilo.org/public/english/protection/ses/download/docs/gold.pdf) — used as a further corroborating independent host.
5. Base de Données sur la Solidarité et l'Économie Sociale (socioeco.org), bibliographic record for the paper. [socioeco.org](https://www.socioeco.org/bdf_fiche-document-2145_en.html) — used for confirming author, title, and publisher (Bien-Suisse) details.
6. Karl Widerquist & Michael W. Howard (eds.), *[Alaska's Permanent Fund Dividend: Examining Its Suitability as a Model](/wiki/widerquist-howard-pfd/)*, Palgrave Macmillan, 2012 — used only for contrast, to distinguish Goldsmith's later book chapter in that volume from this earlier, independent 2002 paper.
