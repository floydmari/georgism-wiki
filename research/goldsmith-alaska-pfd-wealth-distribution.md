...
excerpt: Goldsmith's 2002 BIEN paper reviews 20 years of the Alaska Permanent Fund
  ...
  — and had become so popular that cutting it was considered.
...
1. Scott Goldsmith (2002), "The Alaska Permanent Fund Dividend: An Experiment in Wealth Distribution," paper prepared for the 9th International Congress of the Basic Income European Network (BIEN), Geneva, Switzerland, September 12–14, 2002. [BIEN PDF](https://basicincome.org/bien/pdf/2002Goldsmith.pdf) — the primary text; used for all quoted findings on poverty/inequality reduction (pp. 11, 15), rural cash income (p. 12), political durability (pp. 7, 13), and the absence of formal social-impact studies (p. 12). Page references are to this PDF.
2. Scott Goldsmith (2010), "The Alaska Permanent Fund Dividend: A Case Study in Implementation of a Basic Income Guarantee," presented at the 13th Basic Income Earth Network Congress, University of São Paulo, Brazil, July 2010. [ISER PDF](https://iseralaska.org/static/legacy_publication_links/bien_xiii_ak_pfd_lessons.pdf) — Goldsmith's later companion paper (note: not a mirror of the 2002 paper); used for the Alaska Native poverty-rate figure (25% to 19%, 1980–1990 censuses) cited in the misattribution note above.
3. ScholarWorks @ University of Alaska, item record for "The Alaska Permanent Fund Dividend: An Experiment in Wealth Distribution" (Goldsmith, 2002). [ScholarWorks](https://scholarworks.alaska.edu/uaa_iser_reports/1752/) — used as a corroborating bibliographic record.
4. International Labour Organization (ILO), Social Security Extension mirror of the same 2002 paper (identical text, re-paginated). [ILO PDF](https://webapps.ilo.org/public/english/protection/ses/download/docs/gold.pdf) — used as a corroborating independent host.
