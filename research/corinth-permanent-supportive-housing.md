...
- **It genuinely tempers optimistic supply readings.** With that scope stated, the paper is a real check on any claim that homelessness can be ended simply by adding units at the current margin without regard to the surrounding housing market — which is why it belongs in the outcome page's `challenged_by`, not its `supported_by`.

## Bears On

- [Outcome: Homelessness is a housing-cost problem](/wiki/homelessness-is-housing-cost-problem/) — listed in that page's `challenged_by`: it complicates the intervention corollary of the housing-cost thesis.
- [Quigley, Raphael & Smolensky (2001)](/wiki/quigley-raphael-smolensky-homeless/) and [Hanratty (2017)](/wiki/hanratty-local-economic-homelessness/) — the market-level results Corinth's finding qualifies but does not overturn.
- [Colburn & Aldern, *Homelessness Is a Housing Problem*](/wiki/colburn-aldern-homelessness/) — the anchor book, whose two-level (who vs. how many) framing helps reconcile Corinth's small program effect with the strong rent-geography relationship.
...
1. Kevin Corinth (2017), "The impact of permanent supportive housing on homeless populations," *Journal of Housing Economics* 35: 69–84. DOI: [10.1016/j.jhe.2017.01.006](https://doi.org/10.1016/j.jhe.2017.01.006). Abstract via [RePEc/IDEAS](https://ideas.repec.org/a/eee/jhouse/v35y2017icp69-84.html) and [AEI](https://www.aei.org/research-products/journal-publication/the-impact-of-permanent-supportive-housing-on-homeless-populations/) — fetched and read 2026-07-11; used for the 2007–2014 panel design, the 0.04–0.12 association, and the IV estimate (≤0.10, upper bound 0.72 rejected at 95%).
2. Kevin Corinth (2015), "Ending Homelessness: More Housing or Fewer Shelters?", AEI Economic Policy Working Paper 2015-12. [aei.org PDF](https://www.aei.org/wp-content/uploads/2015/11/Corinth-Ending-Homelessness.pdf) — abstract fetched and read 2026-07-11; used for the first-year 0.12 effect and its full muting after the first year, driven by the shorter-spell subpopulation.
