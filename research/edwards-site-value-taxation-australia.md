...
- Mary E. Edwards
category: research
excerpt: Regression study of Australian local-government site-value rating (1951/52-1974/75)
  finding that jurisdictions taxing land more and improvements less have significantly
  higher average new-house values and a larger housing stock.
...
- **Outcome:** [Split-rate taxation increases construction](/wiki/split-rate-increases-construction/) — an earlier, cross-national empirical test of the same mechanism
- **Concept:** [Site value](/wiki/site-value/) — the tax base whose effects the study measures

## See Also

- [Site Value](/wiki/site-value/) — the tax base Edwards studies
- [Split-Rate Taxation](/wiki/split-rate-taxation/) — the general policy family this Australian evidence bears on
- [Gemmell, Grimes & Skidmore: New Zealand](/wiki/gemmell-grimes-skidmore-nz/) — the equivalent New Zealand empirical literature on land-value rating
- [Dwyer: Taxable Capacity of Australian Land](/wiki/dwyer-taxable-capacity-australia/) — a later, revenue-focused Australian Georgist study
- [Pittsburgh](/wiki/pittsburgh/) — the graded-tax jurisdiction Edwards uses as a US comparison
- [Land Is a Big Deal (book)](/wiki/land-is-a-big-deal/) — the discovery source citing this study

## Sources

1. Mary E. Edwards, "Site Value Taxation in Australia: Where Land Is Taxed More and Improvements Less, Average Housing Values and Stocks Are Higher," *The American Journal of Economics and Sociology* 43(4) (October 1984), pp. 481–495 — used for the study's methodology, data period (1951/52–1974/75), state coverage, regression findings on new-house values and housing stock, the review of Hutchinson (1963) and Woodruff & Ecker-Racz (1969), the Pittsburgh comparison, and the concluding assessment (quotation under 50 words). [JSTOR](https://www.jstor.org/stable/3486127) · [Free PDF (Cooperative Individualism)](https://cooperative-individualism.org/edwards-mary_site-value-taxation-in-australia-1984-oct.pdf)
2. *[Land Is a Big Deal](/wiki/land-is-a-big-deal/)* (Doucet, 2022), Ch. 21 — discovery source citing this study as part of the international empirical evidence on site-value rating. [Book page](/wiki/land-is-a-big-deal/)