...
- **A serious methodological challenge exists.** The BC Expert Panel's 2020 report (see [companion entry](/wiki/bc-basic-income-panel-final-report/)) cites unpublished work by economist David Green disputing the causal read: plotting the Dauphin-minus-controls hospitalization gap, Green finds "the convergence ... happens almost entirely *after* the experiment has ended," and "there was already a trend toward convergence underway before Mincome" — more consistent with a pre-existing trend (possibly a newly built Dauphin hospital clearing an admissions backlog, a confound Forget herself flags at p. 295) than a treatment effect timed to the payment years.
