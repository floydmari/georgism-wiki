...
It is the source behind the "Kuminoff & Pope (2013) hedonic-regression method" that the practitioner-author Lars Doucet lists in [*Does Georgism Work?*](/wiki/doucet-does-georgism-work/) Part 1 as one of the twelve estimation methods for aggregate US land value. The paper is **evidentiary, not advocacy** — the authors do not argue for a [land value tax](/wiki/land-value-tax/), but their method and results bear directly on how large and how separable land value is.
...
3. Lars Doucet (2021), *Does Georgism Work? Part 1: Is Land Really a Big Deal?*, *Astral Codex Ten* — used only for the attribution that Part 1 lists the "Kuminoff & Pope (2013) hedonic-regression method" among its land-value estimation methods. See [wiki page](/wiki/doucet-does-georgism-work/).
