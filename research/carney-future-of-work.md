...
- Mark Carney
category: research
excerpt: "Carney's 2018 Whitaker Lecture uses 'Engels' pause' and a destruction/productivity/creation framework to argue automation could raise inequality 'by construction' via unequal capital ownership — but proposes only skills, labour-institution, and monetary-policy responses, not redistribution."
last_reviewed: 2026-07-15
source_url: https://www.bis.org/review/r180914b.pdf
stub: false
...
A companion to the wiki's AI/automation research trio: [Gen-AI: Artificial Intelligence and the Future of Work (IMF, 2024)](/wiki/imf-gen-ai-future-of-work/) supplies labour-market exposure estimates Carney's speech predates; [Korinek & Stiglitz](/wiki/korinek-stiglitz-ai-rents/) formalize the "scarce factor captures the gains" logic Carney states informally; [Leduc & Liu](/wiki/leduc-liu-automation-bargaining/) model a bargaining-power mechanism complementing Carney's framework. Carney adds none of their formal modeling, but supplies the widest-circulation, most authoritative statement of the historical base rate (Engels' pause) and a clean articulation of why unequal capital ownership turns automation into inequality — useful for framing the wiki's AI-and-inequality lane, without itself being rent-capture evidence.
...
- [Automation, Bargaining Power, and Labor Market Fluctuations (Leduc & Liu)](/wiki/leduc-liu-automation-bargaining/)
- [Economic Rent](/wiki/economic-rent/)

## Sources

1. Mark Carney, "The Future of Work," 2018 Whitaker Lecture, Central Bank of Ireland, Dublin, 14 September 2018, reprinted as BIS Review r180914b. [PDF](https://www.bis.org/review/r180914b.pdf) — read in full, 13 pages (2026-07-15); the Bank of England's own hosted-slides URL is dead, so the BIS Review reprint, which matches the Bank's PDF in content, is the text used — used for the venue and date, the destruction/productivity/creation framework, the Engels' pause discussion, the automation-risk and labour-share figures, all direct quotations, and confirmation (via full-text search) that land, economic rent, and UBI/redistribution instruments are not discussed.
