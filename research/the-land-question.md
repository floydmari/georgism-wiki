...
1. Henry George (1881), *The Irish Land Question: What It Involves, and How Alone It Can Be Settled*, retitled *The Land Question* in later printings. D. Appleton and Company. Full text hosted by the Henry George Institute. [henrygeorge.org](https://www.henrygeorge.org/) and the [Schalkenbach](/wiki/robert-schalkenbach-foundation/)-affiliated archive [wealthandwant.com](https://www.wealthandwant.com/HG/irish_land_question.html) — used for the book's title, subtitle, and the two direct quotations on the "universal question" framing and the indictment of "private property in land."
