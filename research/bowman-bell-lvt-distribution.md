...
1. John H. Bowman & Michael E. Bell (2008), "Distributional Consequences of Converting the Property Tax to a Land Value Tax: Replication and Extension of England and Zhao," *National Tax Journal* 61(4), Part 1, pp. 593–607. [IDEAS/RePEc record](https://ideas.repec.org/a/ntj/journl/v61y2008i4p593-607.html); DOI [10.17310/ntj.2008.4.02](https://doi.org/10.17310/ntj.2008.4.02) — used for the paper's exact citation, methodology (28,680 Roanoke, VA parcels, 2003), and the headline progressive finding contrasted with Dover, NH. `[VERIFY: full text not directly fetched this session — journals.uchicago.edu and jstor.org both returned HTTP 403; findings triangulated from the RePEc abstract plus multiple independent, agreeing search-engine summaries.]`
...
3. Common Wealth Canada, "Assessing the Distributional Impacts of a Land Value Tax," 2024 — [wiki summary](/wiki/cwc-distributional-impacts-lvt/) — used for the parallel point that LVT-alone incidence can fail to be progressive absent specific design choices.
