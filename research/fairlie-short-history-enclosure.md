...
- **Narrative (planned):** `the-great-land-robbery` — per `narratives/_framework.md`, this essay is the enclosure-history source that narrative's factual backbone needs before drafting; it documents dispossession but does not itself supply the further argument that rent capture is the appropriate remedy.
