...
- [Outcome: Homelessness is a housing-cost problem](/wiki/homelessness-is-housing-cost-problem/) — supplies fixed-effects evidence that median rent, not poverty, drives community homelessness rates.
- [Quigley, Raphael & Smolensky (2001)](/wiki/quigley-raphael-smolensky-homeless/) — the earlier multi-dataset test Hanratty extends with HUD panel data.
- [Colburn & Aldern, *Homelessness Is a Housing Problem*](/wiki/colburn-aldern-homelessness/) — the book-length statement of the same conclusion.
- [Corinth (2017), permanent supportive housing](/wiki/corinth-permanent-supportive-housing/) — the complementary intervention-side study; both papers stress that shelter/housing supply institutions shape the measured population.
...
1. Maria Hanratty (2017), "Do Local Economic Conditions Affect Homelessness? Impact of Area Housing Market Factors, Unemployment, and Poverty on Community Homeless Rates," *Housing Policy Debate* 27(4): 640–655. DOI: [10.1080/10511482.2017.1282885](https://doi.org/10.1080/10511482.2017.1282885). Publisher: [Taylor & Francis](https://www.tandfonline.com/doi/abs/10.1080/10511482.2017.1282885) — abstract fetched and read 2026-07-11; used for the 2007–2014 HUD panel design, the cross-sectional results, the fixed-effects finding that only median rent remains significant, and the right-to-shelter poverty caveat.
