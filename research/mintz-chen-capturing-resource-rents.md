...
1. Jack Mintz & Duanjie Chen (2012), "Capturing Economic Rents from Resources through Royalties and Taxes," SPP Research Papers, Vol. 5, Issue 30, University of Calgary School of Public Policy. [PDF (spp.ucalgary.ca mirror)](https://spp.ucalgary.ca/sites/default/files/teams/1/Publications/economic-rents-mintz-chen.pdf) — used for the full text: rent definition, optimal royalty design criteria, METRR cross-jurisdiction comparison, and the Alberta oil-sands conclusion. (The original policyschool.ca URL failed a TLS certificate check at fetch time.) The headline METRR figures cited on this page (Australia −20.1%, Brazil 57.6%, Norway 28.2%, Alberta conventional oil 40%, Alberta oil-sands 28%) were spot-checked against the paper's own tables (Table 2 and Table 3) and prose discussion and matched in each case (2026-07-18); the Appendix A theoretical model and the Appendix B–E jurisdiction-specific input parameters were not independently re-derived.
