...
- [Gans — Market Power in Artificial Intelligence](/wiki/gans-market-power-in-ai/) — a systematic three-market (training data, input data, predictions) competition-economics framework for the same underlying concentration question
