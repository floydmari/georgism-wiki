...
The paper extends the land-decomposition literature associated with [Matthew Rognlie's](/wiki/rognlie-capital-share/) reanalysis of Piketty's capital-share data to a national case — Spain — not covered by Rognlie's original US/cross-country study, adding a country where land's share of wealth is unusually pronounced.
...
1. Miguel Artola Blanco, Luis E. Bauluz & Clara Martínez-Toledano (2018), "Wealth in Spain, 1900-2014: A Country of Two Lands," WID.world Working Paper N° 2018/05 — used for the abstract's core findings: the J-shaped wealth-income ratio, agricultural/urban land's outsized share of national wealth in the early 20th and 21st centuries respectively, and the 45%-of-real-growth-from-housing-capital-gains (1950-2010) figure (verified against the paper's abstract and text). [PDF](https://wid.world/www-site/uploads/2018/02/WID.WP_ABM_WEALTHSPAIN_2018.pdf)
...
(Doucet's specific chapter-level use of this paper — *Land is a Big Deal* Ch. 6 and 17 — is taken from the book's citation record and has not been independently verified against the primary book text.)
