...
- **The 15% tax-to-GDP threshold is a policy heuristic, not a precise economic law.** Independent commentary on the paper (e.g., a Biopharma Business Intelligence Unit analysis) cautions that the figure functions more as a classification/target device than a universal causal threshold, and that it should not be treated as mechanically applicable to every country's fiscal circumstances.
- **Primary-text verification.** The full primary PDF has been read directly, via an Internet Archive snapshot of the IMF's own PDF URL. The title, authorship, 15%-threshold framing, 71-country count, ~5%-of-GDP tax-gap estimate, and the property-tax passage and figures quoted above (pp. 3, 14, 22) are verified against the paper's text.
