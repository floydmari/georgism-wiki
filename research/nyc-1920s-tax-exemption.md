...
- Mary Conyngton
category: research
excerpt: New York City exempted new dwellings (not land) from local property tax, 1921–1931, coinciding with the biggest building boom in city history — Georgists' clearest large-city "untax buildings" natural experiment, though causation is contested.
...
- mason-gaffney
tier: important
title: "New York City's 1921–1931 Tax Exemption for New Housing"
year: 1922
---
...
The central caveat is causal attribution. The 1920s were a nationwide US residential construction boom — postwar catch-up, urbanization, credit expansion — and New York's surge sits inside that larger wave. **Resolved (2026-07-18, T2 verification):** US Bureau of the Census annual housing-starts data (as compiled in Demographia's "USA Housing Starts per 1,000 Households, 1920-2008" series) puts national housing starts at 247,000 (1920), 449,000 (1921), 716,000 (1922), 871,000 (1923), 893,000 (1924), 937,000 (1925, the national peak), 849,000 (1926), 810,000 (1927), 753,000 (1928), and 509,000 (1929) — a near-quadrupling from 1920 to the 1925 peak, then a decline that began *before* the exemption expired in 1931. This confirms New York's boom sat inside a genuine nationwide surge (consistent with the causal-attribution caveat above), but the national series alone cannot isolate New York's specific share of, or deviation from, that trend — Conyngton's cross-city comparisons (Philadelphia, Boston, above) remain the more direct evidence for New York outpacing peer cities within the same national wave. Barr's modern treatment emphasizes New York-specific factors other than the exemption — permissive 1916 zoning codes, the absence of rent control after the emergency tenant laws lapsed, and abundant developable outer-borough land — and does not treat the exemption as the leading explanation. Conyngton's own rebuttal to contemporary skeptics — cross-city permit comparisons — is suggestive, observational evidence, not a matched quasi-experimental design of the kind the Pittsburgh literature later achieved. Gaffney's population comparison carries its own wrinkle: Manhattan actually *lost* population from 1920 to 1940, with growth concentrated in the outer boroughs — plausibly because the $5,000 cap bound less tightly against Manhattan's higher costs — a pattern he does not fully resolve.
...
4. Citizens Housing & Planning Council of New York (2024), "How Tax Incentives Broke The Housing Deadlock in NYC (1960)," revisiting a 1960 CHPC report. [chpcny.org](https://chpcny.org/how-tax-incentives-broke-the-housing-deadlock-in-nyc-1960/) — used for the >760,000-unit decade total and ~22%-of-current-stock figure. **Underlying 1960 report identified (2026-07-18, T2 verification):** the report itself is digitized in full at the same 2024 CHPC page's linked PDF and was fetched and inspected directly this session — Special Committee on Tax Policies, Citizens' Housing and Planning Council of New York, Inc., *How Tax Exemption Broke the Housing Deadlock in New York City: A Report of a Study of the Post World War I Housing Shortage and the Various Efforts to Overcome It* (May 1960), sponsored under a grant from the **Robert Schalkenbach Foundation** (the Georgist foundation) — a fact not previously noted on this page. Its Preface, read directly from the title-page image and OCR'd, is signed **Walter Rybeck**; the title page states "[a]ll opinions expressed herein are either Mr. Rybeck's, in the Preface, or drawn from records of the period studied." [PDF (chpcny.org)](https://chpcny.org/wp-content/uploads/2024/01/How_Tax_Exemption_Broke_Deadlock_NYC.pdf) — cover page and Preface pages read directly; the report's 218 pages were not read in full this session, only its title/attribution front matter.
5. Russil Wvong (2025), "NYC: A Huge Housing Boom in the 1920s," *More Housing* (Substack). [morehousing.substack.com/p/al-smith](https://morehousing.substack.com/p/al-smith) — navigation source only; consulted to identify the Gaffney paper, not cited for any claim above.
6. Demographia (compiler), "USA Housing Starts per 1,000 Households, 1920-2008: All Housing Units," sourced to the US Bureau of the Census. [demographia.com/db-hstarts.pdf](http://demographia.com/db-hstarts.pdf) — used for the national annual housing-starts series, 1920-1929, cited above as comparison context; fetched and read directly 2026-07-18.
