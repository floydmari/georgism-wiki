...
| [**Choi & Sjoquist (2015)**](/wiki/choi-sjoquist-atlanta-lvt-cge/) — modern extension | Urban CGE calibrated to metropolitan Atlanta | Switch from a capital property tax to a land value tax | Refines the earlier models by using *resident* (not absentee) landowners, three income groups, imperfectly mobile housing capital, and a labor-leisure margin; finds full capitalization onto owners, an 18–19% welfare gain (vs. DiMasi's 6.6%), and a progressive incidence across income groups[5] |
...
**The consistent direction.** DiMasi's headline — lower land rents *and* house prices, higher wages, a smaller urban area, and a welfare gain up to 6.6% of revenue — is the reference result the whole cluster orbits. Haughwout's NYC model produces very large gains when the City's high-distortion tax mix (sales, income, property, corporate) is replaced by land taxation: private capital stock rising over 200%, output and land values over 100%, in the most responsive scenario. [Choi & Sjoquist's](/wiki/choi-sjoquist-atlanta-lvt-cge/) Atlanta model reaches broadly similar qualitative conclusions with a more realistic ownership and labor structure — and adds a genuinely new result to this literature for the wiki: extended to three income groups, the welfare gain from switching to a revenue-neutral LVT is **progressive**, larger for lower-income households than for higher-income ones (see the dedicated page for the full breakdown and the model's honest caveats).
...
5. **Ki-Whan Choi & David L. Sjoquist (2015)**, "Economic and Spatial Effects of Land Value Taxation in an Urban Area: An Urban Computable General Equilibrium Approach," *Land Economics* 91(3): 536–555. [DOI](https://doi.org/10.3368/le.91.3.536) — **full text fetched and read (2026-07-18)**, superseding the earlier abstract-only citation: an Atlanta-calibrated urban CGE of switching from a capital property tax to an LVT, distinguished from "prior simulation studies" by resident (not absentee) landowners, three income groups, imperfectly mobile housing capital, and a labor-leisure choice — used for the modern Atlanta extension row above. Full findings (revenue-neutral rates, welfare-gain magnitudes, the progressivity result, capital-mobility and ownership sensitivity) are on its own dedicated page: [Choi & Sjoquist (2015)](/wiki/choi-sjoquist-atlanta-lvt-cge/). Doucet's *Land Is a Big Deal* (Ch. 21) lists this paper among those supporting full capitalization of LVT into land prices — the [landlords cannot pass LVT to tenants](/wiki/landlords-cannot-pass-lvt-to-tenants/) claim carries it via this cluster as model evidence.
