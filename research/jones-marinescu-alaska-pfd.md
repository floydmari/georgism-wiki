...
- **Outcome:** [Resource-rent dividends are workable and durable](/wiki/resource-rent-dividends-work/) — this is the best available rigorous econometric evidence (as opposed to descriptive/administrative evidence) that Alaska's dividend has not visibly damaged the state's labor market over decades of operation, strengthening the "durable and workable" claim with a causal-design test of its most obvious risk.
- **Event:** [Establishment of the Alaska Permanent Fund](/wiki/alaska-permanent-fund/) — this paper is the leading academic evaluation of the labor-market consequences of the Fund's dividend, the mechanism the event page describes.
- **Concept:** [Citizen's Dividend](/wiki/citizens-dividend/) — supplies empirical grounding for the "administratively workable" and "does not obviously discourage work" components of the citizen's-dividend concept.
...
1. Damon Jones & Ioana Marinescu (2022), "The Labor Market Impacts of Universal and Permanent Cash Transfers: Evidence from the Alaska Permanent Fund," *American Economic Journal: Economic Policy*, 14(2): 315–340. [AEA](https://www.aeaweb.org/articles?id=10.1257%2Fpol.20190299) — used for the published abstract, journal citation, and headline findings (no aggregate employment effect; +1.8 pp / ~17% part-time employment; general-equilibrium/local-demand interpretation; tradable vs. non-tradable sector asymmetry).
2. Damon Jones & Ioana Marinescu, "The Labor Market Impacts of Universal and Permanent Cash Transfers: Evidence from the Alaska Permanent Fund," NBER Working Paper No. 24312 (issued Feb. 2018, revised Jan. 2020). [NBER](https://www.nber.org/papers/w24312) — used for the working-paper history/dates and as the earlier circulating version of the same study.
3. IZA Institute of Labor Economics, Discussion Paper No. 11356 (same title/authors). [IZA](https://www.iza.org/publications/dp/11356/the-labor-market-impacts-of-universal-and-permanent-cash-transfers-evidence-from-the-alaska-permanent-fund) — used as a corroborating independent listing of the abstract and findings.
4. SSRN working-paper listing, Damon Jones & Ioana Elena Marinescu. [SSRN](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3118343) — used as a corroborating independent listing confirming authorship and title.

[VERIFIED 2026-07-11 (Hermes fact-check lane): the AEA article page (aeaweb.org/articles?id=10.1257/pol.20190299) was fetched directly and its published abstract confirms the headline findings verbatim — the PFD "had no effect on employment" and "increased part-time work by 1.8 percentage points (17 percent)"; "the empirical results are consistent with cash stimulating the local economy—a general equilibrium effect"; "Nontradable sectors have a more positive employment response than tradable sectors"; and "a universal and permanent cash transfer does not significantly decrease aggregate employment." The full text, exact point estimates, standard errors/confidence intervals, and table-level detail remain behind the AEA/NBER paywall and were not read first-hand; a future editor with working full-text access should confirm those against the primary AEJ:Economic Policy text or the NBER PDF.]