...
Brown's paper is theoretical and illustrative, not empirical in the modern sense — the "vacant lots inside a growing city" pattern is offered as a commonly observed fact, not measured with data, and the numerical example illustrates tax-incidence arithmetic rather than estimating effects in real land markets. Brown himself is candid that his conclusion is a considered judgment ("strongly inclined to suspect") rather than a demonstrated result, and he declines to claim discouraging idle-holding is land-value taxation's primary justification, calling it "a relatively minor" advantage next to the efficiency and equity arguments he emphasized elsewhere. The paper does not address the question modern research treats as central and contested — whether land value taxes are actually capitalized into land prices (see the divided Danish quasi-experimental evidence on the wiki's speculation-dampening page) — since capitalization theory in its modern form postdates this paper. Brown's characterization of Carver's position was checked directly against the primary text: T.N. Carver, *Principles of National Economy* (Boston: Ginn & Co., 1921), pp. 736–739 — chapter "The Single Tax," section "Is land kept out of use for speculation?" — read in full via the Internet Archive's free, non-lending-restricted OCR text (`principlesofnati00carv`). Carver's own words match Brown's quotation verbatim: "If an individual, Jones by name, has a tract of land which is not being used, there is no reason for believing that he would be averse to getting some income year by year while the land itself is rising in value on his hands... There are not many men who deliberately prefer a smaller to a larger income" (p. 737) — confirming Brown's footnote citation to that exact page. Carver's further concession, that land divided into building lots ahead of demand "practically goes to waste" (p. 738), is likewise accurately paraphrased by Brown. Brown's characterization is accurate and not overstated: Carver does doubt that land-holding is generally speculative, on essentially the grounds Brown attributes to him, while separately allowing the narrower building-lot-oversupply case.
...
3. Thomas Nixon Carver (1921), *Principles of National Economy* (Boston: Ginn & Co.), pp. 736–739. Public domain; read in full via the Internet Archive's OCR full text. [archive.org/details/principlesofnati00carv](https://archive.org/details/principlesofnati00carv) · [full OCR text](https://archive.org/download/principlesofnati00carv/principlesofnati00carv_djvu.txt) — used to independently verify Brown's quotation and page citation of Carver's argument that land ownership is unlikely to be kept idle for pure speculation.
