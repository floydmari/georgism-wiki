...
- **Publication status (checked 2026-07-17): now peer-reviewed and published.** The FRBSF working paper version read for this entry (February 2023) has since been published as Sylvain Leduc & Zheng Liu, "Automation, Bargaining Power, and Labor Market Fluctuations," *American Economic Journal: Macroeconomics* 16(4): 311-349 (October 2024), DOI [10.1257/mac.20220181](https://doi.org/10.1257/mac.20220181) — confirmed via the AEA's own listing and its IDEAS/RePEc mirror. AEJ: Macroeconomics is a top-field, peer-reviewed AEA journal, so the paper's mechanism and quantitative findings now carry that higher evidentiary weight rather than working-paper status; this entry's page-level content still tracks the FRBSF working-paper text (not independently re-verified against the final journal typesetting) and should be treated as a close match, not a claim of section-by-section identity.
...
2. Sylvain Leduc & Zheng Liu (2024), "Automation, Bargaining Power, and Labor Market Fluctuations," *American Economic Journal: Macroeconomics* 16(4): 311-349, DOI: [10.1257/mac.20220181](https://doi.org/10.1257/mac.20220181) — the published, peer-reviewed version of Source 1; citation details (journal, volume, issue, pages) confirmed via the [AEA's listing](https://pubs.aeaweb.org/doi/10.1257/mac.20220181) and [IDEAS/RePEc](https://ideas.repec.org/a/aea/aejmac/v16y2024i4p311-49.html), checked 2026-07-17; the published PDF itself is paywalled and was not fetched, so page-level content on this wiki page still cites the free working-paper text.
