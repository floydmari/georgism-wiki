...
- **Working paper status.** As of the version read (February 2023), the paper is a Federal Reserve Bank working paper; the views are stated to be "solely the responsibility of the authors" and not those of the Federal Reserve System. [VERIFY: publication/peer-review status in a journal as of any later date.]
