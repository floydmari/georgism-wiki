...
- Dirk J. Bezemer
bears_on_objections:
- bubbles-cannot-be-identified-in-advance
category: research
...
(3) have made the prediction personally and in the public domain, "rather than
being asserted by others"; and (4) attach "some timing" to it.[1] Applying these
led to exactly **twelve** analysts (Table 1), who shared a common feature:
**accounting / flow-of-funds models** tracking credit and asset markets, against
the equilibrium models that dominated policy.[1] MPRA Paper 15892 (June 2009); the
analysis also circulated as a University of Groningen working paper and in a VoxEU
column.[1][2]
...
sources (see [his page](/wiki/fred-foldvary/)) and should not be attributed to
Bezemer's audit.

This page de-references the citation carried by
[the cycle narrative](/wiki/land-speculation-causes-cycles/) and
...
- [Progress & Poverty's 18.6-year cycle record](/wiki/progress-18-6-year-cycle/)
- [Harrison, Boom Bust](/wiki/harrison-boom-bust/) — one of the audited predictions
