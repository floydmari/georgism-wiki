...
1. Peter Mieszkowski (1972), "The Property Tax: An Excise Tax or a Profits Tax?", *Journal of Public Economics* 1(1): 73–96. [DOI: 10.1016/0047-2727(72)90020-5](https://doi.org/10.1016/0047-2727(72)90020-5) (paywalled via ScienceDirect/Elsevier) — used for the paper's title, venue, page range, and its core theoretical argument (the profits-tax/excise-tax decomposition and land-borne-by-landowners result), corroborated across multiple secondary academic summaries. A free full-text mirror at [gabriel-zucman.eu](https://gabriel-zucman.eu/files/teaching/Mieszkowski72.pdf) (course teaching materials) was read in full (2026-07-11), confirming the paper's principal conclusion verbatim: "The principal conclusion of this paper is that the system of property taxes imposed by local governments decreases the overall return to capital by the average rate of tax in the nation as a whole" (p. 94). The paper's body explicitly brackets the pure land/site-rent-tax incidence question in the general case ("we exclude from consideration the question of whether taxes on site rents are borne by the owners of land … the incidence of taxes on urban land rents remains an unsettled question") while affirming full landowner incidence for the fixed-supply case: "For the case of a developed city it is unlikely that a land tax will have much of an impact on the supply of land in urban use, and a land tax will be borne by the owners of land." This page's "land borne entirely by landowners" framing follows the fixed-supply case, which is somewhat more specific than the paper's own hedged treatment of the general incidence question.
