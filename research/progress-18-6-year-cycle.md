...
1. Progress.org, "The 18-Year Pattern Predicting 2027's Market Crash" (page slug `18-6-year-real-estate-cycle`), n.d. [Progress.org](https://www.progress.org/articles/18-6-year-real-estate-cycle/) — the subject of this page. Direct fetch returned HTTP 403 during this research pass; content reconstructed from converging search-engine excerpts and not verified against raw HTML — `[VERIFY]` throughout this page marks unconfirmed specifics, including author and exact publication date.
2. Fred E. Foldvary, "The Business Cycle: A Georgist-Austrian Synthesis," *American Journal of Economics and Sociology* 56(4), 1997, pp. 521–541. [PDF via cooperative-individualism.org](https://cooperative-individualism.org/foldvary-fred_the-business-cycle-a-georgist-austrian-synthesis-1997-oct.pdf) — used for the verbatim 1997 prediction of a ~2008 downturn, independently corroborated outside the Progress.org article itself.
3. Homer Hoyt (1933), *One Hundred Years of Land Values in Chicago* — the original empirical study behind the Chicago peak-year list; already cited on [18-Year Land Cycle](/wiki/18-year-land-cycle/).
4. Fred Harrison (2005), *Boom Bust: House Prices, Banking and the Depression of 2010*. [Publisher](https://shepheardwalwyn.com/product/boom-bust/) — used for Harrison's role in the lineage, already cited on [18-Year Land Cycle](/wiki/18-year-land-cycle/) and [Fred Harrison](/wiki/fred-harrison/).
5. Akhil Patel (2023 per this wiki's existing page; a later 2026 date appeared in one secondary listing during this research pass and is unresolved), *The Secret Wealth Advantage* — used for Patel's role as the contemporary practitioner extending Anderson's framework; see [Akhil Patel](/wiki/akhil-patel/). `[VERIFY: publication year]`
6. Phillip J. Anderson (2008), *The Secret Life of Real Estate and Banking* — used for the "18.6-year" refinement of the cycle length; not independently read for this page, cited via secondary bookseller/publisher listings. `[CITATION NEEDED: a primary or reviewed source for Anderson's specific dating methodology]`
