...
- Felix Creutzig
category: research
excerpt: "A 20-criterion sustainability framework for location value taxes, applied to eight European countries, finds most score poorly against the literature's own design recommendations — Denmark scores highest, but only 11 of 20 points."
last_reviewed: 2026-07-17
source_url: https://api-depositonce.tu-berlin.de/server/api/core/bitstreams/0a276986-8274-4b7f-8ba0-a1f0ecc60598/content
stub: false
...
- policy-design
tier: important
title: "A Systematic Framework of Location Value Taxes Reveals Dismal Policy Design in Most European Countries"
year: 2016
---

## Summary

"A systematic framework of location value taxes reveals dismal policy design in most European countries" is a peer-reviewed article by **Blanca Fernandez Milan, David Kapfer, and Felix Creutzig**, all then at the Mercator Research Institute on Global Commons and Climate Change (MCC Berlin) and the Technical University of Berlin. It appeared in *Land Use Policy*, volume 51 (February 2016), pp. 335–349, DOI: 10.1016/j.landusepol.2015.11.022. The task brief that commissioned this entry named the lead author "Beatriz Fernández Milan"; that name does not appear anywhere in the scholarly record. The paper's own title page, abstract, and affiliation line, TU Berlin DepositOnce's own suggested citation ("Fernandez Milan, Blanca"), her Semantic Scholar profile, her ORCID record (0000-0003-1985-7875), and her later LinkedIn/Ricardo plc biography all independently agree on **"Blanca Fernandez Milan"** — confirmed independently as well against the CrossRef metadata record for this DOI (author order: Blanca Fernandez Milan, David Kapfer, Felix Creutzig) — the task brief's name was simply an error, and this entry follows the confirmed source throughout. This entry is written from the publicly archived postprint hosted by TU Berlin's institutional repository (DepositOnce, DOI 10.14279/depositonce-5769), read in full (38 pages); the MCC Berlin author-page URL for the paper no longer resolves to the PDF, so the DepositOnce postprint serves as the accessible copy of record.
...
- **Concept:** [Land Value Tax](/wiki/land-value-tax/) — supplies a concrete, sourced answer to "how well is LVT actually implemented in practice," useful evidence that the gap between LVT theory and LVT law is real and quantifiable, not merely anecdotal.
- **Place:** [Denmark](/wiki/denmark/) — corroborates, with an independent scoring framework, Denmark's status as the strongest LVT implementation among the European cases surveyed, while also showing its score (11/20) is far from ideal even as the sample's best case.
- **Benefit:** [Taxing land raises productivity](/wiki/taxing-land-raises-productivity/) — indirectly relevant: the paper's core message is that poor design (infrequent reassessment, narrow base, opaque revenue recycling) can blunt whatever productivity and efficiency gains the theory predicts, a caveat advocates should carry when citing the strong theoretical case.
...
- [Taxing land raises productivity](/wiki/taxing-land-raises-productivity/)
- [Economic Rent](/wiki/economic-rent/)

## Sources

1. Blanca Fernandez Milan, David Kapfer & Felix Creutzig (2016), "A systematic framework of location value taxes reveals dismal policy design in most European countries," *Land Use Policy* 51: 335–349, DOI: 10.1016/j.landusepol.2015.11.022. [Postprint PDF via TU Berlin DepositOnce](https://api-depositonce.tu-berlin.de/server/api/core/bitstreams/0a276986-8274-4b7f-8ba0-a1f0ecc60598/content) — used for all findings, the design-criteria framework, the nomenclature table, the eight-country scoring table, and all direct quotations; the 38-page postprint was read in full (2026-07-17). No other open copy of the accepted manuscript has been located, and the publisher's version of record on ScienceDirect (https://www.sciencedirect.com/science/article/abs/pii/S0264837715003853) remains paywalled and unread. The postprint's own cover page states plainly: "(Postprint version is cited, page numbers differ.)" — so its pagination does not match the published 335–349 range. Two of this entry's key claims are page-cited against the postprint's own (non-journal) pagination as partial mitigation: the natural-resource/extraction-rent argument appears on postprint p. 7, and the eight-country Table 3 scores (Denmark 11, Lithuania 8, Slovakia 7, Estonia/Hungary/Austria 5 each, Italy 4, Romania/Slovenia 3) on postprint pp. 18–20 — both checked against the PDF and matching this entry's Summary exactly.
