...
1. Blanca Fernandez Milan, David Kapfer & Felix Creutzig (2016), "A systematic framework of location value taxes reveals dismal policy design in most European countries," *Land Use Policy* 51: 335–349, DOI: 10.1016/j.landusepol.2015.11.022. [Postprint PDF via TU Berlin DepositOnce](https://api-depositonce.tu-berlin.de/server/api/core/bitstreams/0a276986-8274-4b7f-8ba0-a1f0ecc60598/content) — used for all findings, the design-criteria framework, the nomenclature table, the eight-country scoring table, and all direct quotations; fetched and read in full (all 38 pages) this session. A follow-up search for an alternate accepted-manuscript copy (Felix Creutzig's ResearchGate and Academia.edu author pages, the MCC Berlin institutional site, and general web search) found no independent hosting beyond this DepositOnce postprint — channels exhausted; the publisher's version-of-record on ScienceDirect (https://www.sciencedirect.com/science/article/abs/pii/S0264837715003853) remains paywalled and unread. The postprint's own cover page states plainly: "(Postprint version is cited, page numbers differ.)" — confirming, from the repository itself, that its pagination does not match the published 335–349 range. Two of this entry's key claims are page-cited against the postprint's own (non-journal) pagination as partial mitigation: the natural-resource/extraction-rent argument appears on postprint p. 7, and the eight-country Table 3 scores (Denmark 11, Lithuania 8, Slovakia 7, Estonia/Hungary/Austria 5 each, Italy 4, Romania/Slovenia 3) on postprint pp. 18–20 — both checked directly against the PDF and matching this entry's Summary exactly.
