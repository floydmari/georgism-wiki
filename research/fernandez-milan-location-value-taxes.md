...
"A systematic framework of location value taxes reveals dismal policy design in most European countries" is a peer-reviewed article by **Blanca Fernandez Milan, David Kapfer, and Felix Creutzig**, all then at the Mercator Research Institute on Global Commons and Climate Change (MCC Berlin) and the Technical University of Berlin. It appeared in *Land Use Policy*, volume 51 (February 2016), pp. 335–349, DOI: 10.1016/j.landusepol.2015.11.022. **Author-name check (resolved 2026-07-16):** the task brief that commissioned this entry named the lead author "Beatriz Fernández Milan"; that name does not match any record found. The paper's own title page, abstract, and affiliation line give the name as **"Blanca Fernandez Milan,"** confirmed independently against the CrossRef metadata record for this DOI (author order: Blanca Fernandez Milan, David Kapfer, Felix Creutzig) — this entry uses the confirmed name throughout. Written from the publicly archived postprint hosted by TU Berlin's institutional repository (DepositOnce, DOI 10.14279/depositonce-5769), fetched and read in full (38 pages); the original MCC Berlin author-page URL supplied for this task no longer resolves to the PDF (the domain now redirects to the Potsdam Institute's homepage), so the DepositOnce postprint was substituted as the accessible copy of record.
...
1. Blanca Fernandez Milan, David Kapfer & Felix Creutzig (2016), "A systematic framework of location value taxes reveals dismal policy design in most European countries," *Land Use Policy* 51: 335–349, DOI: 10.1016/j.landusepol.2015.11.022. [Postprint PDF via TU Berlin DepositOnce](https://api-depositonce.tu-berlin.de/server/api/core/bitstreams/0a276986-8274-4b7f-8ba0-a1f0ecc60598/content) — used for all findings, the design-criteria framework, the nomenclature table, the eight-country scoring table, and all direct quotations; fetched and read in full (all 38 pages) this session. *Provenance caveat (checked 2026-07-16):* the publisher's version-of-record on ScienceDirect (https://www.sciencedirect.com/science/article/abs/pii/S0264837715003853) remains paywalled. A further search this session (Google Scholar, ResearchGate/Academia.edu, SSRN, and the MCC Berlin/TU Berlin author pages) found no additional free copy beyond this DepositOnce postprint, so pagination differences between the postprint and the version-of-record — a possibility the postprint's own cover page itself flags — were not independently checked. Retry logged in `sources/verification-backlog.md`.
