...
category: research
excerpt: 'Two short Mason Gaffney working notes (1993, revised 2005) on a single
  mechanism: how a rising land price under an existing building silently consumes
  the capital sunk in that building, driving "negative capital formation" as land
  booms peak.'
last_reviewed: 2026-07-16
source_url: https://www.masongaffney.org/workpapers/How_a_Land_Boom_Destroys_Capital_10_2005.pdf
stub: false
...
1. Mason Gaffney, "How Rising Rents Can Devour Capital and Choke Off Production," Working Paper WP039, notes dated November 20, 1993, excerpted from "Causes of Downturn" (1982) — used for the CCA/capital-reproduction mechanism, the equity-withdrawal account, and the "vampire in the night" quotation. Read from the scanned PDF at masongaffney.org (2026-07-16); quotations spot-checked against that PDF. [Free PDF (masongaffney.org)](https://www.masongaffney.org/workpapers/How_Rising_rents_devour_%20capital_1993_WP039.pdf) · [archived](https://archive.progress.org/gaffney/workpapers/How_Rising_rents_devour_%20capital_1993_WP039.pdf); local mirror at `sources/gaffney/`.
2. Mason Gaffney, "How a Land Boom Destroys Capital," working paper, October 2005, a revised excerpt of the same 1982 "Causes of Downturn" Appendix 7 — used for the "factitious locational obsolescence" framing, the 2005-only "Implications" section, the property-tax-revaluation policy conclusion, and the V = a/(i − g + t) valuation identity. Read from the scanned PDF at masongaffney.org (2026-07-16); quotations spot-checked against that PDF. [Free PDF (masongaffney.org)](https://www.masongaffney.org/workpapers/How_a_Land_Boom_Destroys_Capital_10_2005.pdf) · [archived](https://archive.progress.org/gaffney/workpapers/How_a_Land_Boom_Destroys_Capital_10_2005.pdf); local mirror at `sources/gaffney/`.
3. Mason Gaffney, "Urban Expansion — Will It Ever Stop?," *Yearbook of Agriculture* (USDA, 1958), pp. 503–522 — used for the historical-precursor note above (the land-boom-collapse list and "land bubble" framing); read in full 2026-07-18, no dedicated wiki page. [Free PDF (masongaffney.org)](https://masongaffney.org/publications/E1Urban_Expansion_Stop.CV.pdf); local mirror at `sources/gaffney/text/E1Urban_Expansion_Stop.CV.txt`.
