...
tier: important
title: The Great Smoky Mountains Casino-Dividend Natural Experiment
year: 2010
---
...
The Cherokee dividend is a near-textbook instance of the mechanism Georgists propose: a **commonly-owned asset generates a rent, and that rent is returned to every member of the community as an equal per-capita cash dividend** — the same design as the [Alaska Permanent Fund](/wiki/alaska-permanent-fund/) Dividend. It supplies rare **causal** evidence, from a credibly exogenous income shock, on two questions the Georgist dividend literature cares about:

1. **Does an unconditional dividend reduce poverty's harms?** Yes, measurably: lifting families out of poverty improved children's behavioral health (Costello 2003) and their adult education and law-abidingness (Akee 2010) — strengthening the [rent dividends reduce poverty](/wiki/rent-dividends-reduce-poverty/) claim with a design cleaner than the descriptive Alaska evidence. The 2018 follow-up (Akee, Simeonova, Costello & Copeland) extends this to a broader outcome set — personality traits and psychiatric-symptom counts through age 16 — with the same directional result and effects concentrated among the initially worst-off children.
2. **Does the cash discourage work?** No detectable labor-supply withdrawal appears — consistent with [Jones & Marinescu's](/wiki/jones-marinescu-alaska-pfd/) Alaska finding, reinforcing the [durability-and-workability](/wiki/resource-rent-dividends-work/) case.
...
- **The three papers are not equally accessible, and the page's grounding differs accordingly.** Costello et al. (2003, *JAMA*) is paywalled with no open-access version of record; the figures taken from it here come from the full structured abstract (Context/Objective/Design/Population/Results/Conclusions) in the PubMed and Europe PMC records for PMID 14559956. That abstract is unusually detailed — it carries the numeric results and odds ratios quoted above — but it is not the full paper, so methods detail, tables, and discussion nuance beyond it are unverified. Akee et al. (2010, *AEJ: Applied Economics*) is freely available in full as the NIH-deposited author manuscript on PMC (PMC2891175) and is the basis for the 2010 findings above. For Akee, Simeonova, Costello & Copeland (2018, *AER*) the version of record is paywalled, and the personality-trait figures here come from the free pre-publication NBER Working Paper 21562 (2015) of the same study.

## Bears On

- **Outcome:** [Rent dividends reduce poverty and inequality](/wiki/rent-dividends-reduce-poverty/) — supplies causal evidence that an unconditional per-capita dividend improved poverty-linked child outcomes.
- **Outcome:** [Resource-rent dividends are workable and durable](/wiki/resource-rent-dividends-work/) — an independent, long-running per-capita dividend from a co-owned asset with no visible labor-supply cost.
- **Concept:** [Citizen's Dividend](/wiki/citizens-dividend/) — a real-world unconditional dividend whose downstream human-capital effects have been measured.
- **Study:** [Jones & Marinescu, Alaska Permanent Fund](/wiki/jones-marinescu-alaska-pfd/) — companion quasi-experimental dividend evidence.
- **Study:** [Akee, Simeonova, Costello & Copeland (2018)](https://www.nber.org/system/files/working_papers/w21562/w21562.pdf) — the same natural experiment, extended to personality traits and psychiatric-symptom counts through age 16 (NBER WP 21562, mined in full on this page).
...
- [Citizen's Dividend](/wiki/citizens-dividend/) · [Resource Rents](/wiki/resource-rents/)
- [Jones & Marinescu (2022)](/wiki/jones-marinescu-alaska-pfd/)

## Sources

1. E. Jane Costello, Scott N. Compton, Gordon Keeler & Adrian Angold (2003), "Relationships Between Poverty and Psychopathology: A Natural Experiment," *JAMA*, 290(15): 2023–2029. DOI [10.1001/jama.290.15.2023](https://doi.org/10.1001/jama.290.15.2023). Publisher page (paywalled): [JAMA Network](https://jamanetwork.com/journals/jama/fullarticle/197482). **Structured abstract read** via [Europe PMC](https://www.ebi.ac.uk/europepmc/webservices/rest/search?query=EXT_ID:14559956%20AND%20SRC:MED&format=json&resultType=core) / [PubMed](https://pubmed.ncbi.nlm.nih.gov/14559956/) (PMID 14559956), 2026-07-18 — used for the 1,420-child GSMS sample and design, the 14%/53%/32% poverty transitions, the pre/post symptom-frequency scores (4.38 / 4.28 / 2.75) and odds ratios (1.50 [1.08–2.09] ex-poor; 0.91 [0.77–1.07] persistently poor), the ex-poor-fall-to-never-poor finding, the conduct/ODD-specific (not anxiety/depression) result, the same-pattern-in-non-Indian-families note, and the verbatim Conclusions quote. The full paper body (Methods detail, tables, Discussion) is not publicly accessible and is not relied on here — see Nuances and Limits.
2. Randall K. Q. Akee, William E. Copeland, Gordon Keeler, Adrian Angold & E. Jane Costello (2010), "Parents' Incomes and Children's Outcomes: A Quasi-Experiment Using Transfer Payments from Casino Profits," *American Economic Journal: Applied Economics*, 2(1): 86–115. DOI [10.1257/app.2.1.86](https://doi.org/10.1257/app.2.1.86). [AEA](https://www.aeaweb.org/articles?id=10.1257/app.2.1.86); **full text read** via [PMC (NIH author manuscript)](https://pmc.ncbi.nlm.nih.gov/articles/PMC2891175/) (PMCID PMC2891175, PMID 20582231), 2026-07-18 — used for the Eastern Band of Cherokee per-capita distribution design (~$4,000/person/yr since 1996, $3,900 of it passing through to household income), the sample (1,420 children, 350 American Indian / 1,070 non-Indian, 11 counties), the difference-in-differences result (+1 year education at 21 for the poorest households, −22% minor crime at 16–17), the improved-parental-quality mechanism (fathers ~half as likely to be arrested, 3–5% supervision improvement), the no-labor-supply-response finding, and the ruling-out of the casino labor-demand channel (distance-to-casino robustness check).
3. E. Jane Costello, Adrian Angold, Barbara J. Burns, et al. (1996), "The Great Smoky Mountains Study of Youth: Goals, Design, Methods, and the Prevalence of DSM-III-R Disorders," *Archives of General Psychiatry*, 53(12): 1129–1136. [DOI](https://doi.org/10.1001/archpsyc.1996.01830120067012) — used for the original GSMS survey methodology and cohort design; referenced here rather than read directly.
4. Randall Akee, Emilia Simeonova, E. Jane Costello & William Copeland (2018), "How Does Household Income Affect Child Personality Traits and Behaviors?," *American Economic Review*, 108(3): 775–827. DOI [10.1257/aer.20160133](https://doi.org/10.1257/aer.20160133) (paywalled at AEA). **Free pre-publication version read in full**: [NBER Working Paper 21562](https://www.nber.org/system/files/working_papers/w21562/w21562.pdf) (September 2015), 2026-07-18 — used for the personality-trait and symptom effect sizes (behavioral disorders −26.7% SD, emotional disorders −35.6% SD, conscientiousness +42.8% SD, agreeableness +30.6% SD, neuroticism not significant), the concentration of effects among initially-worst-off children, the parental-relationship and reduced-drug/alcohol-use mechanism evidence, and the residential-mobility-to-higher-income-tracts finding. See the working-paper-vs-published caveat above.