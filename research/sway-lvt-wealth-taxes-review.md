...
category: research
excerpt: "A realist review for Reform Scotland/University of Edinburgh's SWAY programme comparing split-rate LVT and net wealth taxes: LVT's development effect depends on context, while net wealth taxes lose large shares of revenue to avoidance and migration."
last_reviewed: 2026-07-17
source_url: https://web.archive.org/web/20241010000000/https://www.reformscotland.com/wp-content/uploads/2024/10/SWAY-report-24-wealth-taxes.pdf
stub: false
...
- realist-review
tier: supplementary
title: "The Economic & Behavioural Impacts of Land Value Taxes & Net Wealth Taxes in OECD Countries: A Realist Review"
year: 2024
---

## Summary

This report is an MSc-dissertation-derived "realist review" by **Sam Wolstenholme-Britt**, a University of Edinburgh MSc Social Research student, produced during a 10-week SWAY placement with **Reform Scotland**, a Scottish public-policy institute. The report itself never spells out the acronym, but the University of Edinburgh's own School of Social and Political Science confirms it directly — SWAY is **Study and Work Away**, the university's placement-adviser service (part of Edinburgh Global) that arranges MSc Social Research "placement-based dissertations," typically an eight-to-ten-week research placement with an external host organisation (think tanks, NGOs, charities, government bodies), matching this report's own description of a "10-week SWAY placement with Reform Scotland" almost exactly.[5] The cover-page byline reads "Sam Wostenholme-Britt," a typographical dropped "l"; every other occurrence, including the "About Sam Wolstenholme-Britt" biography, spells the surname **Wolstenholme-Britt**. The registry's existing author field is confirmed correct on surname and affiliation; this entry adds the given name.
...
- **Objection:** [LVT can't raise enough revenue](/wiki/lvt-not-enough-revenue/) — bears indirectly: the review does not quantify LVT's own revenue potential, but its finding that NWTs lose 44%+ of theoretical revenue to avoidance and underreporting is evidence for the broader claim that a fixed, immobile base is comparatively avoidance-proof, strengthening the response without directly measuring LVT yield.
- **Benefit:** [Taxing land and rents increases productivity](/wiki/taxing-land-raises-productivity/) — qualifies the evidence: supports a development effect from split-rate LVT under specific conditions, while finding the land-tax-specific liquidity effect weaker than the incentive effect from relieving the buildings tax.
- **Benefit:** [LVT can replace capital taxes without efficiency loss](/wiki/lvt-can-replace-capital-taxes-without-efficiency-loss/) — supports by contrast: documents how an elastic, mobile wealth-tax base erodes under avoidance and migration in a way a fixed land base does not.
...
- [Taxation and Economic Growth (OECD Working Paper 620)](/wiki/oecd-taxation-economic-growth/)

## Sources

1. Sam Wolstenholme-Britt (2024), "The Economic & Behavioural Impacts of Land Value Taxes & Net Wealth Taxes in OECD Countries: A Realist Review," Reform Scotland / University of Edinburgh SWAY programme. [Archived PDF](https://web.archive.org/web/20241010000000/https://www.reformscotland.com/wp-content/uploads/2024/10/SWAY-report-24-wealth-taxes.pdf) — used for all findings, quotations, and the study-by-study synthesis of Pennsylvania split-rate LVT, Spanish and Swiss net-wealth-tax, and interwar/postwar capital-levy evidence; read in full (39 pages), 2026-07-17.
...
5. University of Edinburgh, School of Social and Political Science, "Taught MSc Placement-Based Dissertations" course description — used to confirm "SWAY" = Study and Work Away, the Edinburgh Global placement-adviser service coordinating MSc Social Research placement dissertations with external host organisations, and to describe the placement-based-dissertation mechanism the report's author went through. [sps.ed.ac.uk](https://www.sps.ed.ac.uk/students/development-hub/masters/placement-based-learning/msc-placement-based-dissertations) — consulted 2026-07-18.
