...
**Part-1 citation ledger (updated 2026-07-11):** [Kuminoff & Pope (2013)](/wiki/kuminoff-pope-land-values/) and Michael Hudson's [*Where Did All the Land Go?* (2001)](/wiki/hudson-where-did-all-the-land-go/) now have de-referencing pages. Still missing registry rows: Barr, Smith & Kulkarni (2014, Manhattan land value), the AEI Land Price Indicators (the 70.9% SF land-share figure), Saez & Zucman (2015, ownership concentration), Steven Cord's ~24%-of-national-income estimate, Richard Ebeling's federal-lands figure, and the PLACES Lab machine-learning estimate — the ranked ingest shortlist lives in `sources/inbox/T1-TODO-doucet-parts-1-3-dereferencing.md`.
