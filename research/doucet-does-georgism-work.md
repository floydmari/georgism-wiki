...
- **Part-3 citations not yet on the wiki** — the substantive gap. Doucet's mass-appraisal papers reach the wiki only second-hand through his summary; none has its own registry row or page:
  - **Kolbe, Schulz, Wersing & Werwatz (2019), *Land Value Appraisal Using Statistical Methods*** (Berlin) — the single most load-bearing Part-3 source (the 0.845 semiparametric figure), plus the companion **Kolbe et al., *Identifying Berlin's land value map using adaptive weights smoothing***.
  - **Hefferan & Boyd (2010), *Property taxation and mass appraisal valuations in Australia*** — the <1%-objection and <2%-complaint benchmarks.
