...
- **Land share of urban property value is high** — his San Francisco "spot check" (a vacant lot vs. an adjacent sold townhouse) yields ~76% land, congruent with AEI's 70.9% county figure for SF (2020).
...
**Part-1 citations not yet on the wiki** (flagged for a future ingest pass): [Kuminoff & Pope (2013)](/wiki/kuminoff-pope-land-values/) hedonic-regression method; Michael Hudson, *Where Did All the Land Go?* (2001, the Fed-critique Doucet leans on); Barr, Smith & Kulkarni (2014, Manhattan land value); Steven Cord's ~24%-of-national-income estimate; Richard Ebeling's federal-lands figure; the PLACES Lab machine-learning estimate. [CITATION NEEDED: these six Part-1 sources want registry rows and, where weighty, de-referencing pages.]
...
- **Part-3 citations not yet on the wiki** — the substantive gap. Doucet's mass-appraisal papers reach the wiki only second-hand through his summary; none has its own registry row or page:
  - **[Kolbe, Schulz, Wersing & Werwatz (2019)](/wiki/kolbe-berlin-land-value-appraisal/), *Land Value Appraisal Using Statistical Methods*** (Berlin) — the single most load-bearing Part-3 source (the 0.845 semiparametric figure), plus the companion **Kolbe et al., *Identifying Berlin's land value map using adaptive weights smoothing***.
  - **[Hefferan & Boyd (2010)](/wiki/hefferan-boyd-mass-appraisal-australia/), *Property taxation and mass appraisal valuations in Australia*** — the <1%-objection and <2%-complaint benchmarks.
  - **Almy (2014), *Valuation and Assessment of Immovable Property*** (OECD Working Paper) — the €20/property cost figure.
  - **Gloudemans & Almy (2011), *Fundamentals of Mass Appraisal*** (IAAO textbook).
  - **Bencure, Tripathi, Miyazaki, Ninsawat & Kim (2019), iLVM** (BayBay City); **Yalpir & Unel (2017)** (Konya MRA); **Fuest et al. (2018)** (ifo Grundsteuer cost comparison); plus minor cites Kilić et al. (2019), Raslanas et al. (2014), Aragonés-Beltrán et al. (2008), Xue et al. (2008), and Kettani & Khelifi (2001).

  [CITATION NEEDED: the Berlin cluster (Kolbe ×2), Hefferan & Boyd, and Almy 2014 are Important-tier assessment evidence and warrant de-referencing pages feeding /wiki/mass-appraisal-methods/ and /wiki/land-cannot-be-assessed/; the remaining case studies want at least registry rows.]
