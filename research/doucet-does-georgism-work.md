...
Lars Doucet's *"Does Georgism Work?"* series, published on Astral Codex Ten in 2021–22, is the most widely read modern empirical examination of land value taxation. Written for a general but analytically demanding audience, it grew out of Doucet's ACX Book Review Contest-winning review of *[Progress and Poverty](/wiki/progress-and-poverty/)* and launched the contemporary Georgism revival in rationalist and effective-altruist circles.

[Doucet](/wiki/lars-doucet/) is a self-identified Georgist and a practitioner-advocate (games-industry analyst, later co-founder of the [Center for Land Economics](/wiki/center-for-land-economics/)), and states his bias openly at the outset: "I'm a Georgist, and I would be happy to find this philosophy true and sad to find it false" (Part 1). This page therefore treats the series as a **navigation source** — a well-organized synthesis whose evidential weight rests on the primary studies it cites, not on Doucet's own authority. The "citation ledger" sections below de-reference the actual sources behind Parts 1 and 3, routing each to the primary study (with its own wiki page where one exists) and flagging those not yet ingested. [ATCOR](/wiki/atcor/) and the [Henry George Theorem](/wiki/henry-george-theorem/) appear in the series as **attributed theory**, not established results, consistent with Doucet's own caveats.

## The Three Parts

1. **Is land really a big deal?** Examines whether land values are large enough to matter — concluding they are, consistent with [Rognlie](/wiki/rognlie-capital-share/) and [Bonnet et al.](/wiki/bonnet-land-is-back/)
2. **Can landlords pass LVT on to tenants?** Works through tax incidence and argues that, because land supply is fixed, an LVT is borne by the landowner and cannot be passed to tenants.
3. **Can unimproved land value be assessed?** Tackles the assessment objection and concludes land can be assessed with accuracy at least comparable to existing property assessment.
...
- Land-value estimates: [Albouy, Ehrlich & Shin, *Metropolitan Land Values* (2018)](/wiki/albouy-ehrlich-shin-metro-land/) (incl. the "online appendix" showing dense pure-land sales in city centers); [Larson, *New Estimates of the Value of Land of the United States* (2015)](/wiki/larson-us-land-value/) (hedonic); [Davis, Larson, Oliner & Shui, FHFA (2019)](/wiki/davis-larson-oliner-shui-fhfa-land/) (cost approach, vacant-land sales excluded); [Yglesias's Federal Reserve method (2013)](/wiki/davis-larson-oliner-shui-fhfa-land/); *[Counting Bounty](/wiki/land-rent-could-fund-government/)* (Jeffrey J. Smith, 2020) — the source of the Foldvary, Tideman, Gaffney and Cord data points.
- Rent-share-of-income anchor: [Dwyer, *The Taxable Capacity of Australian Land and Resources* (2003)](/wiki/dwyer-taxable-capacity-australia/) — the paper behind Foldvary's "one-third of national income" claim, which Doucet recomputes to ~21% and flags Foldvary as "contradicted by his own source."
- Theory: [ATCOR](/wiki/atcor/) (Gaffney, *The Physiocratic Concept of ATCOR*, 2005 — attributed hypothesis); [Henry George Theorem](/wiki/henry-george-theorem/) ([Arnott & Stiglitz origin paper](/wiki/arnott-stiglitz-henry-george-theorem/); [practical guide](/wiki/arnott-hgt-practical-guide/)). Doucet relays Tideman's private-correspondence gloss that a non-pure-public-goods variant holds "the combination of land value increases and charges equal to marginal cost will finance these expenditures," but "neither theorem applies if people have different tastes or if benefits do not decline with distance" (Tideman, quoted in Part 1).
- Policy synthesis: [Tideman, Kumhof, Hudson & Goodhart, *Post-Corona Balanced-Budget Super-Stimulus* (2021)](/wiki/goodhart-stimulus/), which Doucet points readers to as the worked-out policy paper.

**Part-1 citation ledger (updated 2026-07-11):** [Kuminoff & Pope (2013)](/wiki/kuminoff-pope-land-values/) and Michael Hudson's [*Where Did All the Land Go?* (2001)](/wiki/hudson-where-did-all-the-land-go/) now have de-referencing pages, as do three more Part-1 anchors: [Barr, Smith & Kulkarni, *What's Manhattan Worth?*](/wiki/barr-smith-kulkarni-manhattan-land/) (the vacant-land-sales index valuing Manhattan's developable land at ~$1.47T — published in *Regional Science and Urban Economics* 2018, not the JUE), the [AEI Land Price Indicators](/wiki/aei-land-price-indicators/) (the 70.9% SF land-share figure), and [Saez & Zucman (2016)](/wiki/saez-zucman-wealth-inequality/) (the wealth-concentration primary). The three remaining minor Part-1 data points — all reaching Doucet second-hand through *Counting Bounty* — are now de-referenced (registry rows pending ingest, annotated on [land-rent-could-fund-government](/wiki/land-rent-could-fund-government/)): **Steven Cord's** estimate is [Cord (1985), *AJES* 44(3):279–293](https://cooperative-individualism.org/cord-steven_how-much-revenue-would-a-full-land-value-tax-yield-1985.pdf), whose primary headline is **28%** of 1981 national income (Smith/Doucet quote it as ~24%); **Richard Ebeling's** federal-lands figure is the ~$5.5T federal land+mineral value in his [*There Is No Social Security Santa Claus*](https://www.fff.org/explore-freedom/article/there-is-no-social-security-santa-claus/) (Future of Freedom Foundation, 21 Dec 2015), which Doucet himself flags as method-free; and the **PLACES Lab** machine-learning estimate is Christoph Nolte's Boston-University land-value maps ([Nolte 2020, *PNAS* 117(47):29577–29583](https://doi.org/10.1073/pnas.2012865117); placeslab.org). The ranked ingest shortlist lives in `sources/inbox/T1-TODO-doucet-parts-1-3-dereferencing.md`.

## Part 3 — Can Unimproved Land Value Be Assessed?

Part 3 is the series' assessment installment and the least-ingested of the three. Doucet prepared for it by attending [Ted Gwartney's](/wiki/gwartney-estimating-land-values/) five-week Henry George School course *Assessing Land Values — Principles and Methods*, surveying ~a dozen mass-appraisal papers from Google Scholar, and reading the [International Association of Assessing Officers](/wiki/mass-appraisal-methods/) (IAAO) standards. His structure:
...
- **Modern methods.** The empirical core, from recent mass-appraisal papers: **multiple regression analysis**, **nonparametric kernel regression**, **nonparametric adaptive-weights smoothing**, **semiparametric regression**, and expert-weighted models (AHP / iLVM). His headline evidence is the Berlin study by **Kolbe, Schulz, Wersing & Werwatz**: the semiparametric method reached a **0.845 correlation** with the traditional expert-assessed land-value map (BRW) — roughly ±15% — while the plain kernel method managed only 0.704 and was "not able to produce estimates for the city center." He also cites **[Almy (2014)](/wiki/almy-oecd-valuation-assessment/)** for a ~€20-per-property assessment cost (≈1% of receipts) and the developing-country **[iLVM](/wiki/bencure-ilvm-baybay-philippines/)** study (Bencure et al., BayBay City, Philippines) explaining ~67% of variance.
...
- **Now de-referenced (updated 2026-07-18):** **[Gloudemans & Almy (2011), *Fundamentals of Mass Appraisal*](/wiki/fundamentals-of-mass-appraisal/)** (IAAO textbook — the methods backbone) has its own page, built from IAAO's course materials and standards rather than the paywalled full text, which remains inaccessible.
- **Still second-hand only** (ranked ingest shortlist in `sources/inbox/T1-TODO-doucet-parts-1-3-dereferencing.md`): **Yalpir & Unel (2017)** (Konya MRA); **Fuest et al. (2018)** (ifo *Grundsteuer* cost comparison — distinct from the fuest-peichl-siegloch incidence paper already on the wiki); plus minor cites Kilić et al. (2019), Raslanas et al. (2014), Aragonés-Beltrán et al. (2008), Xue et al. (2008), and Kettani & Khelifi (2001).
...
- **Concept:** [Mass appraisal methods](/wiki/mass-appraisal-methods/) · [ATCOR](/wiki/atcor/) · [Henry George Theorem](/wiki/henry-george-theorem/)
- **Book:** [*Land Is a Big Deal*](/wiki/land-is-a-big-deal/) — the book-length expansion of this series

## Sources

1. Lars Doucet (2021–22), *Does Georgism Work?* — used as a **navigation / advocacy-adjacent source** (§3 source hierarchy: an advocate representing his own position) that works through the three empirical cruxes (is land a big share of value; can LVT be passed to tenants; can land be assessed); the underlying magnitudes and assessment results are attributed to, and de-referenced to, the primary studies on the pages this one links.
   [Part 1: Is Land Really a Big Deal?](https://www.astralcodexten.com/p/does-georgism-work-is-land-really) · [Part 2: Can Landlords Pass LVT to Tenants?](https://www.astralcodexten.com/p/does-georgism-work-part-2-can-landlords) · [Part 3: Can Land Be Assessed?](https://www.astralcodexten.com/p/does-georgism-work-part-3-can-unimproved), *Astral Codex Ten*. Verbatim quotes above (Krugman, Tideman, Gwartney, and Doucet's own hedged conclusion) transcribed from Parts 1 and 3, each ≤50 words with part-level locators. Primary source for the Krugman quotation (which Doucet carries second-hand): Michael Scott Moore, "This Land Is Your Land," *Pacific Standard*, from Moore's 2008 Berlin interview with Krugman. [psmag.com](https://psmag.com/news/this-land-is-your-land-3392/)
2. Lars Doucet (2022), *Land Is a Big Deal* (book). [landisabigdeal.com](https://www.landisabigdeal.com/) — the book-length treatment; see [book page](/wiki/land-is-a-big-deal/).
