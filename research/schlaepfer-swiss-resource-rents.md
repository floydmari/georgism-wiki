---
title: "Total Rents from Natural Resources: Framework and Preliminary Estimates for Switzerland (Schläpfer, 2026)"
category: research
authors:
- Felix Schläpfer
year: 2026
tier: Important
source_url: https://doi.org/10.1016/j.ecolecon.2025.108821
supports_outcomes:
...
- economic-rent
stub: false
excerpt: "A 2026 Ecological Economics paper proposes a four-part 'total rents from natural resources' framework, estimating Swiss rents (2016-2021) at CHF 298bn/year — 42% of GDP, 89% from urban land — more than the country's combined tax revenue."
last_reviewed: 2026-08-10
---

## Summary

**"Total rents from natural resources: Framework and preliminary estimates for Switzerland"** is a peer-reviewed paper by **Felix Schläpfer** (Kalaidos University of Applied Sciences through 2024-12-31, now FS Economic Research, Winterthur), published in *Ecological Economics*, volume 240, article 108821, with a first-view date of 8 October 2025 and a February 2026 print issue.[1] The paper is open access under a CC-BY license, but its full text on the publisher's site has not been accessible; the abstract, author affiliation, and journal metadata are independently confirmed via scholarly metadata records, though the paper's own body text remains unread. Schläpfer's own project site (felixschlaepfer.ch / naturkapital.ch) hosts a freely downloadable November 2024 German-language final report underlying this research program — Schläpfer & Lobsiger, *Naturkapital Schweiz: Kapitalwerte, Erträge und Transfers nach institutionellen Sektoren 2016/2021* (Zenodo, CC-BY 4.0) — which sets out the same four-category framework and data sources in full methodological detail.[3] That report is a companion/predecessor document by the same authors, not the *Ecological Economics* article itself, so the figures below are grounded in a read primary methods document even though the peer-reviewed paper's own text remains inaccessible.
...
This is a broader accounting lens than the "economic rent" concept as usually applied on this wiki (see [Economic Rent](/wiki/economic-rent/)): it explicitly separates *capital gains from asset appreciation* (category 2) from *rights transfers via policy* (category 3) and *unpriced externalities* (category 4), rather than lumping them into a single rent figure.
...
- **Problem:** [Land rent could fund a large share of government](/wiki/land-rent-could-fund-government/) — a new country-level data point (Switzerland) for the wiki's cross-national land-rent-capacity evidence, in the tradition of the Australian, Canadian, and Vermont estimates already cited there
- **Concept:** [Economic Rent](/wiki/economic-rent/) — Schläpfer's four-part decomposition (rent / gain / transfer / externality) refines the single-concept treatment this wiki page uses

## Limits and Honest Assessment

This page is built from the paper's verified abstract, matching the publisher's own indexed metadata, a corroborating open-access companion study, and the authors' own November 2024 German-language methods report, not a read of the *Ecological Economics* article's own full text: the publisher page's full text has not been accessible, and no independent open-access mirror of that specific article's complete body text was located.
...
- [Total Resource Rents of Australia (Fitzgerald / Prosper Australia)](/wiki/total-resource-rents-australia/) — the closest structural analog: a national total-rent inventory finding rents at 23.6% of GDP
- [Natural Common Wealth and Economic Rent in Canada](/wiki/natural-common-wealth-economic-rent-canada/) — a similar Canadian national rent inventory
- [Valuing Common Assets for Public Finance in Vermont](/wiki/valuing-common-assets-vermont/) — a US state-level predecessor using a related method
- [Economic Rent](/wiki/economic-rent/)
- [Land rent could fund a large share of government](/wiki/land-rent-could-fund-government/)

## Sources

1. Felix Schläpfer (2026), "Total rents from natural resources: Framework and preliminary
   estimates for Switzerland," *Ecological Economics*, 240, 108821 — used for the four-part
   framework and the CHF 78bn/167bn/23bn/31bn (CHF 298bn total, 42% of GDP, 89% urban land)
   estimates; abstract independently verified via the OpenAlex scholarly metadata API (which
   confirms open-access CC-BY status). [DOI: 10.1016/j.ecolecon.2025.108821](https://doi.org/10.1016/j.ecolecon.2025.108821).
2. Felix Schläpfer & Michael Lobsiger (2026), "Who benefits from natural capital in
   Switzerland? An analysis of resource rents by groups of beneficiaries," *Frontiers in
   Environmental Economics*, 5, 1787849 — full text read; used for the corroborating and more
   granular CHF 159–223bn/beneficiary-group breakdown, for confirming the framework paper's core
   finding that urban land dominates Swiss resource rents, and for the paper's own explicit
   statement that its total is lower than and not directly reconciled with the *Ecological
   Economics* paper's CHF 298bn figure. Fully open access.
   [frontiersin.org](https://www.frontiersin.org/journals/environmental-economics/articles/10.3389/frevc.2026.1787849/full).
3. Felix Schläpfer & Michael Lobsiger (2024), "Naturkapital Schweiz: Kapitalwerte, Erträge und
   Transfers nach institutionellen Sektoren 2016/2021," Kalaidos Fachhochschule Zürich / BSS
   Volkswirtschaftliche Beratung, 30 November 2024 — full text read (German); the predecessor
   methods report underlying the framework paper and companion study above, used for the
   CHF 159.0bn total and its CHF 70.9/45.7/14.6/27.7bn component breakdown, the definitional
   split between "Kapitalgewinn" (resource gain) and "Kapitaltransfer" (resource transfer), and
   the external-cost data sources (ARE 2023a for transport, Ecoplan 2022 for energy, Schläpfer
   2020 for agriculture, Schläpfer 2024b for urban land-take). CC-BY 4.0.
   [zenodo.org/records/14257912](https://zenodo.org/records/14257912) ·
   [PDF](https://zenodo.org/records/14257912/files/Naturkapital_Schweiz_Schlussbericht_final.pdf).
