...
1. Ben Earle, Liam Wilkinson, Floyd Marinescu & Ken Yang (Common Wealth Canada), *Natural Common Wealth and Economic Rent in Canada*, January 2023 (v.3, working paper). PDF: [commonwealth.ca/s/Natural-Common-Wealth-and-Economic-Rent-in-Canada_Jan-2023.pdf](https://www.commonwealth.ca/s/Natural-Common-Wealth-and-Economic-Rent-in-Canada_Jan-2023.pdf) — **the primary report**, retrieved and read in full for this revision. Used for the title, authorship, publication date; the Summary-of-Findings / Table 1 rent figures ($474.4B total possible, $53.3B current, $421.01B additional); the $362.5B/$401B land value tax figures (Table 4); the sector methodologies (Tables 5–12); and the Table 3 / Table 3.1 tax-reduction, dividend, and permanent-fund scenarios. (A prior research session reported HTTP 403 on this URL; it retrieved successfully — HTTP 200, 8-page PDF — with a browser user-agent in this session.)
...
**Provenance note.** As of this review, no independent academic, government, or third-party critical assessment of *this specific report's* methodology or figures (e.g., from Statistics Canada, the Fraser Institute, or academic public-finance economists) has been located, despite a dedicated search; the available search results return only Common Wealth Canada's own materials restating the report. Its estimates should therefore be treated as an advocacy organization's own analysis — contested and not independently replicated or peer-reviewed — rather than as settled figures. The report's primary-source figures cited above are, by contrast, confirmed verbatim against the report PDF itself.