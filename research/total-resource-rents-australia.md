...
excerpt: Prosper Australia's 2013 report (by Karl Fitzgerald) tallying the economic
  ...
  to run all three levels of government in 2011-12 — rising.
...
*Total Resource Rents of Australia: Harnessing the Power of Monopoly* (2013, second revision) is a report by **Karl Fitzgerald**, then Projects Director of [Prosper Australia](/wiki/prosper-australia/), the Melbourne-based Georgist research and advocacy organisation. It updates the late Tony O'Brien's *Total Resource Rents of Australia* (1999), and works line-by-line through Australian land, natural resources, and government-licensed monopolies to ask how much [economic rent](/wiki/economic-rent/) exists and how much government it could fund. [Verified against the primary PDF's title page, About, and Acknowledgements.]
...
- **Relation to Dwyer.** [Terence Dwyer's "The Taxable Capacity of Australian Land and Resources" (2003)](/wiki/dwyer-taxable-capacity-australia/) is the earlier, journal-published (*Australian Tax Forum*) national-accounts calculation that TRRA's conclusion echoes — that Australian land and resource rents are large enough to replace existing taxation. Dwyer's paper is the more-cited academic companion; TRRA is the broader advocacy inventory, extending the base from land and resources to licensed monopolies (spectrum, banking, gambling, taxis, domains). This wiki's Dwyer page is a stub whose headline magnitudes remain unverified, so the two estimates cannot yet be reconciled figure-for-figure here; the qualitative convergence of the two Australian exercises is what this wiki carries.
- **No independent replication located.** As with the Canadian successor report, no government, academic, or third-party critical assessment of TRRA's specific figures has been located; the estimates should be treated as contested pending such review.

## Bears On

- **Outcome:** [Land rent could fund a large share of government](/wiki/land-rent-could-fund-government/) — TRRA is the Australian worked example on the optimistic ("advocate aggregation") side of that debate: rents at 23.6% of GDP, funding 87% of all-levels government operating revenue, versus mainstream measured-rent figures an order of magnitude lower. It belongs alongside — and predates — the [Common Wealth Canada estimate](/wiki/natural-common-wealth-economic-rent-canada/) already carried on that page.
- **Objection:** [LVT can't raise enough revenue](/wiki/lvt-not-enough-revenue/) — the report is a direct country-level rebuttal attempt, though a contested one (see Limits).
- **Concepts:** [Economic Rent](/wiki/economic-rent/) · [Resource Rents](/wiki/resource-rents/) · [Land Value Tax](/wiki/land-value-tax/) · [ATCOR](/wiki/atcor/) (the report's excluded $66.3B efficiency dividend and predicted commercial-land value rises are ATCOR-adjacent claims)
- **People / organizations:** [Karl Fitzgerald](/wiki/karl-fitzgerald/) · [Prosper Australia](/wiki/prosper-australia/) — the report sits alongside Prosper's [speculative vacancy](/wiki/speculative-vacancy/) research (cited within TRRA: 90,730 Melbourne residential vacancies, 2011) and Fitzgerald's documentary [*Real Estate 4 Ransom*](/wiki/real-estate-4-ransom/).
...
- [Objection: LVT can't raise enough revenue](/wiki/lvt-not-enough-revenue/) — the steelmanned opposing view
- [Gaffney, "The Hidden Taxable Capacity of Land"](/wiki/gaffney-hidden-taxable-capacity/) — the US-side optimistic argument

## Sources

1. Karl Fitzgerald, *Total Resource Rents of Australia: Harnessing the Power of Monopoly* (Prosper Australia, 2013, second revision). [PDF](https://www.prosper.org.au/wp-content/uploads/2013/12/TRRA_2013_final.pdf) — **the primary report**, retrieved and read in full for this page. Used for all headline figures (23.6% of GDP; 87% / $340.719B of $390.067B; the Table 1 schedule and $386.905B total; Table 2 shares; the 5.5%/6.5% land method and $3.68 trillion ABS land-value base; the 40% EBITDAX mining/petroleum method; the $66.3B efficiency dividend and 90%/23% distortion claims; the $18,403 median-home worked example; and the stated assumptions), all verified verbatim.
2. Tony O'Brien, *Total Resource Rents of Australia* (1999) — the predecessor study this report updates, cited within the primary PDF (Acknowledgements and Part V); not independently retrieved (last review 2026-07-12).
3. Terence Dwyer, "The Taxable Capacity of Australian Land and Resources," *Australian Tax Forum* 18(1), 2003 — used for the comparison to the earlier academic Australian estimate (see the caveat in Limits; magnitudes unverified on this wiki). [Wiki page](/wiki/dwyer-taxable-capacity-australia/)
4. Common Wealth Canada, *Natural Common Wealth and Economic Rent in Canada* (2023, two versions) — used for the downstream adoption and subsequent revision of TRRA-style land-rent methods, as documented on [this wiki's page](/wiki/natural-common-wealth-economic-rent-canada/) (verified there against both primary PDFs).
5. This wiki, [Land rent could fund a large share of government](/wiki/land-rent-could-fund-government/) — used for the framing that national rent-capacity estimates are contested and method-sensitive.