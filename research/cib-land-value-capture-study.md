...
- development-charges
tier: important
title: "Land Value Capture Study: Paying for Transit-Oriented Communities"
year: 2023
---

## Summary

"Land Value Capture Study: Paying for Transit-Oriented Communities" (April 2023) is a report by **Matti Siemiatycki, Drew Fagan, and Robert Nutifafa Arku** of the Infrastructure Institute at the University of Toronto's School of Cities. It is not a Canada Infrastructure Bank (CIB) publication authored by CIB staff: the report's front matter states plainly that "the findings and conclusions in this report are those of the Infrastructure Institute at the University of Toronto's School of Cities. Any errors or omissions in fact or interpretation remain the sole responsibility of the Institute," followed immediately by "[t]he Institute also thanks the Canada Infrastructure Bank for its financial support of this project" — CIB commissioned and funded the study, but the analysis and recommendations are the university researchers' own. That paragraph is the entirety of CIB's role as stated in the report's own front matter: a funding acknowledgment, not a named client review, sign-off, or approval. Fetched and read in full (49 pages) for this entry.

**Resolved 2026-07-18:** re-extracted the PDF's full plain text directly (not just via summarization) and searched it systematically for "acknowledg-", "Canada Infrastructure Bank," "CIB," "reviewed by," "approved by," "endorse," "sign-off," and "comments/feedback from." The full disclaimer/acknowledgment paragraph adds only two clauses beyond what this page already quotes above: authors' errors/omissions "remain the sole responsibility of the Institute," and the authors' thanks to "Infrastructure Institute staff for their assistance in the editing and production of this report" — CIB is named only once in that paragraph, as the project's financial supporter. No other CIB mention in the document takes the form of a review, sign-off, endorsement, or approval — every other occurrence of "CIB" in the report (about a dozen, concentrated in the closing "Opportunities for the CIB" discussion) is the authors' own analysis of what role CIB *could* play as a future investor in LVC-adjacent mechanisms, not a statement attributable to CIB itself. The one unrelated hit for "approved by" in the full-text search referred to a New Brunswick municipal council approval, not CIB. This settles the marker: CIB's role in this report is funder only, named once, with no further sign-off of any kind.
...
- **Concept:** [Land Value Capture](/wiki/land-value-capture/) — a detailed, current (2023) practitioner-level survey of LVC mechanism design and Canadian implementation experience, useful for policymaker-staffer readers who need concrete instrument comparisons and dollar figures rather than theory alone.
- **Problem:** [Public investment capitalizes into land values](/wiki/public-investment-capitalizes-into-land/) — the report's Canadian and international case studies (Scarborough, Capstan, Crossrail, Hong Kong) are additional real-world confirmations that transit investment measurably raises nearby land value, the precondition LVC mechanisms exploit.
- **Research:** [Dachis, "Buyers Beware"](/wiki/dachis-buyers-beware-housing-barriers/) — both papers are Canadian-focused, both discuss development charges as a distortionary funding tool and land-value-based alternatives as a preferable substitute; this report's emphasis on the administrative complexity and modest yield of LVC mechanisms is a useful complement/caution to Dachis's recommendation to replace upfront development charges with land-value capture and user fees.
...
1. Matti Siemiatycki, Drew Fagan & Robert Nutifafa Arku (2023), "Land Value Capture Study: Paying for Transit-Oriented Communities," Infrastructure Institute, University of Toronto School of Cities, supported by the Canada Infrastructure Bank, April 2023. [PDF](https://cdn.cib-bic.ca/files/documents/Corporate/Land-Value-Capture-Study-April-2023.pdf) — used for all findings, the mechanism taxonomy, all Canadian and international case-study figures, and all direct quotations; fetched and read in full (all 49 pages) this session.
