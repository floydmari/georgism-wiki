...
Replacing taxes on **capital** with a tax on **land** improves economic efficiency with no offsetting loss. Because land is fixed in supply it bears [zero deadweight loss](/wiki/deadweight-loss/), whereas taxing capital reduces investment at the margin. A revenue-neutral swap therefore raises total welfare.
...
- [Taxing land and rents increases productivity](/wiki/taxing-land-raises-productivity/) — the stronger growth claim built on this page's well-supported core, graded honestly
