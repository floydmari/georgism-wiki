...
| 9 | **PLACES Lab** ML fair-market-value estimate (placeslab.org) | A machine-learning aggregate land estimate | **MISSING** | INGEST — low/medium. Grey-lit/tool, no paper; registry row (Dataset, supplementary). |
...
| 12 | **Steven Cord** ~24%-of-national-income estimate (cooperative-individualism.org) | A US rent-share-of-income data point | **MISSING** | INGEST — low. Secondary web article; registry row (Article, supplementary). |
| 13 | **Richard Ebeling** (2015) federal land+mineral holdings ~$5.5T | A land-value data point (via Smith) | **MISSING** | **No ingest.** Doucet himself discounts it ("no methodology... take his word for it"). Cited second-hand through *Counting Bounty*. Skip. |
