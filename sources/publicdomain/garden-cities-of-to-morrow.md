---
title: "Garden Cities of To-morrow (Ebenezer Howard, 1902)"
# NOTE: repo-hosted public-domain full text (EDITORIAL §3b) — NOT a wiki page.
# The wiki page about this work is books/garden-cities-of-to-morrow.md.
tags: [texts, ebenezer-howard, garden-cities, urban-planning, land-value-capture, rate-rent, unearned-increment, town-planning, communal-land]
authors: [Ebenezer Howard]
year: 1902
public_domain: true
provenance: "Ebenezer Howard, Garden Cities of To-morrow (Being the Second Edition of 'To-morrow: A Peaceful Path to Real Reform') (London: Swan Sonnenschein & Co., Ltd., 1902). Transcribed text from Project Gutenberg eBook #46134 (https://www.gutenberg.org/cache/epub/46134/pg46134.txt), fetched 2026-07-11. Public domain (published 1902; author Ebenezer Howard died 1928, i.e. >70 years). Mechanical cleanup only, no modernization: the Project Gutenberg header and licence boilerplate were removed from the top, and the Gutenberg end-boilerplate plus the transcriber's correction/hyphenation-note list were removed from the bottom. The top 'Transcriber's Note' (recording that italics are marked with _underscores_ and bold with =equals signs=) was also removed; those in-text markup conventions are left exactly as transcribed. No words were altered, added, or paraphrased; spelling, punctuation, [Illustration:] markers, and the diagram legends are reproduced as in the Gutenberg transcription."
stub: false
excerpt: "The complete text of Ebenezer Howard's 1902 Garden Cities of To-morrow: the founding manifesto of the garden-city movement, proposing self-financing new towns on communally-held land where the rising ground rent — Howard's 'rate-rent' — is captured for the community rather than private landlords. Public domain; full text hosted in this repository."
last_reviewed: 2026-07-11
---

## Editorial note

This is the complete text of *Garden Cities of To-morrow* by **Ebenezer Howard**
(1850–1928), the 1902 second edition of the book first published in 1898 as *To-morrow:
A Peaceful Path to Real Reform*. It is the founding document of the
[garden-city movement](/wiki/garden-city-movement/): Howard's proposal for planned new
towns of limited size, ringed by a permanent agricultural belt, built on land bought at
agricultural value and held in trust for the townspeople, so that the rising ground rent
the community itself creates — the [unearned increment](/wiki/unearned-increment/) — returns
to the community rather than to private landlords.

The wiki holds it because it is the primary record of one of the clearest schemes ever built
to capture community-created land value. Howard had read [Henry George](/wiki/henry-george/)
and made land-value capture the financial foundation of the town: his "rate-rent" mechanism
(Chapter II) is a practical instrument for recovering the unearned increment through communal
freehold rather than through a tax — a [land value capture](/wiki/land-value-capture/)
precedent adjacent to, rather than inside, the [land value tax](/wiki/land-value-tax/) family.
Letchworth (1903) and Welwyn Garden City (1920) put the scheme into practice.

For the wiki's summary, key arguments, and honest limits, see the book page:
[Garden Cities of To-morrow](/wiki/garden-cities-of-to-morrow/). What follows is the
unabridged text.
