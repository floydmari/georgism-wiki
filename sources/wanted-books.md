# WANTED: Books to queue for scanning when an electronic copy is found
...
|------|-------------------------------|
| **⭐ Moses & Brigham, *The Natural Dividend: Just Management of our Common Resources* (Agenda Publishing, 2023)** — **PRIORITY: Floyd-requested synthesis, 2026-07-07** | Norwegian scholarly treatment of collective ownership of nature with the resulting rents returned to the people as a "natural dividend" — the resource-rent + citizen's-dividend thesis stated directly, with domain chapters on land, fisheries (salmon), renewable energy, and fossil/mineral resources. Would seed a new `books/moses-brigham-natural-dividend` page and upgrade [resource-rents](../concepts/resource-rents.md), [resource-rent-dividends-work](../outcomes/resource-rent-dividends-work.md), [citizens-dividend](../concepts/citizens-dividend.md), [sovereign-wealth-fund](../concepts/sovereign-wealth-fund.md), the [common-wealth-fund](../research/common-wealth-fund.md) proposal, and the Norway GPFG / [Alaska PFD](../places/alaska-permanent-fund.md) cases. Authors: Jonathon W. Moses (NTNU) & Anne Margrethe Brigham (Ruralis). ISBN 9781788214391; also on Cambridge Core. Not yet in registry. |
...
| **Widerquist & Howard (eds.), *Alaska's Permanent Fund Dividend* (Palgrave, 2012)** | The scholarly volume on the PFD as a model — feeds [citizens-dividend narrative](../narratives/citizens-dividend-narrative.md) and the dividends outcome. Still paywalled as a full copy (Springer), but front matter/TOC + the full Ch. 12 (Casassas & De Wispelaere, pp. 169-188) obtained 2026-07-14 via a contributor-hosted PDF (davidcasassas.com); page numbers for all 15 chapters now primary-confirmed on [widerquist-howard-pfd](../research/widerquist-howard-pfd.md). Goldsmith's central empirical chapter (pp. 49-64) still not directly read — the highest-value remaining gap. |
| **Lars Doucet, *Land is a Big Deal* (2022)** | The movement's best modern popularizer; the ACX series is scanned but the book's additional material (assessment chapters especially) is not. Not in registry as a book row. |

## Tier 2 — would fill known evidence gaps or planned pages

| Book | Why it matters / what it feeds |
|------|-------------------------------|
| **Posner & Weyl, *Radical Markets* (2018)** **[backlog]** | The COST/Harberger-tax chapter backs the [radical-markets stub](../concepts/radical-markets.md) (queued for backfill) and [harberger-tax](../concepts/harberger-tax.md). ~~One copy also closes the page-cite backlog on [vickrey-counterspeculation-auctions](../research/vickrey-counterspeculation-auctions.md) and [myerson-satterthwaite-bilateral-trade](../research/myerson-satterthwaite-bilateral-trade.md).~~ ✓ Both page-cite items closed 2026-07-14 using Princeton University Press's free Ch. 1 sample chapter ([assets.press.princeton.edu/chapters/s11222.pdf](https://assets.press.princeton.edu/chapters/s11222.pdf)) — sufficient for those two pinned citations, but a full copy is still wanted for the broader COST/Harberger-tax backfill (only Ch. 1 pp. 29–79 is covered by the sample). Registry: Light. |
| **Katharina Pistor, *The Code of Capital* (Princeton, 2019)** | Direct page cites (pp. 4, 86, 93, 229, 317-318) now on [pistor-code-of-capital](../research/pistor-code-of-capital.md), obtained via Pistor's own 2021 *Social & Legal Studies* rejoinder essay and a Jotwell review quoting the book verbatim — no archive.org copy or Google Books preview exists, so a full cover-to-cover read would still deepen the page (sovereign-debt/IP chapters untouched by the two sources used). |
...
| **Brent Ranalli, *Common Wealth Dividends: History and Theory* (Palgrave, 2021)** | The comprehensive introduction to common-wealth dividends, cited by CWC's *Natural Common Wealth* paper (fns 7, 46); would anchor [citizens-dividend](../concepts/citizens-dividend.md) and [common-wealth-fund](../research/common-wealth-fund.md). Discovery: natural-common-wealth report. Not in registry. |
| **Guy Standing, *Plunder of the Commons: A Manifesto for Sharing Public Wealth* (Pelican, 2019)** | Commons-fund levy on all rentier income — wanted by [rentier](../concepts/rentier.md), [common-wealth-fund](../research/common-wealth-fund.md), [land-as-commons](../concepts/land-as-commons.md). Discovery: natural-common-wealth report. Not in registry. |
| **Joseph Stiglitz, *The Price of Inequality* (Norton, 2012)** | Rent-seeking → inequality synthesis; source of the "returns to land" rent etymology CWC quotes (its p. 48). Wanted by [joseph-stiglitz](../people/joseph-stiglitz.md), [rent-seeking](../concepts/rent-seeking.md), [rentier](../concepts/rentier.md). Discovery: natural-common-wealth report. Not in registry. |
...
## Tier 3 — biography & depth reserves

| Book | Why it matters / what it feeds |
|------|-------------------------------|
| **Edward T. O'Donnell, *Henry George and the Crisis of Inequality* (Columbia, 2015)** | Best modern George biography — would deepen [henry-george](../people/henry-george.md) and the 1886 election page. |
| ~~**Charles Albro Barker, *Henry George* (1955)**~~ ✓ scanned 2026-07-06 (via IA lending) — see [books/barker-henry-george-biography](../books/barker-henry-george-biography.md) |
| **Steven Cord, *Henry George: Dreamer or Realist?* (1965)** | Reputation history among economists — corruption-narrative context. |
| ~~**Bruce Murray, *The People's Budget 1909/10* (Oxford, 1980)**~~ ✓ scanned 2026-07-06 (via IA lending) — see [books/peoples-budget-1909](../books/peoples-budget-1909.md) |
| **Dominic Frisby, *Daylight Robbery* (2019)** | Popular tax-history framing for [the-tax-you-cant-dodge](../narratives/the-tax-you-cant-dodge.md). |
...
- Howard, *Garden Cities of To-morrow* — public domain, scanned 2026-07-06 — see [books/garden-cities-of-to-morrow](../books/garden-cities-of-to-morrow.md).
- Goldman, *Rendezvous with Destiny* — scanned 2026-07-06 via IA lending — see [books/rendezvous-with-destiny](../books/rendezvous-with-destiny.md).
- Noyes (ed.), *Now the Synthesis* — scanned 2026-07-06 via IA lending — see [books/now-the-synthesis](../books/now-the-synthesis.md).
...
| **Fred Harrison, *The Chaos Makers* (1997)** | The first explicit published prediction of the 2008/2010 crash — primary evidence for the cycle-prediction record (Bezemer/18.6-cycle pages). Discovery: boom-bust report. |
| **J. Parry Lewis, *Building Cycles and Britain's Growth* (1965)** | The scholarly building-cycle dataset back to 1700 Harrison builds on — de-references Boom Bust Ch. 5-6. Discovery: boom-bust report. Checked 2026-07-14: the one archive.org copy (`buildingcyclesbr0000unse`) is lending-restricted (search-inside blocked without a loan); Google Books confirms "17.4" occurs exactly once in the indexed text but shows no snippet/page (no preview tier). A library loan or a non-restricted scan is still needed for the primary Table 5.1 text. |
| **Mason Gaffney, *After the Crash: Designing a Depression-Free Economy* (2009)** | Gaffney's own cycle synthesis (Wiley) — subdivision data and land-market failure mechanics. Discovery: patel report. |
