...
| **Widerquist & Howard (eds.), *Alaska's Permanent Fund Dividend* (Palgrave, 2012)** | The scholarly volume on the PFD as a model — feeds [citizens-dividend narrative](../narratives/citizens-dividend-narrative.md) and the dividends outcome. Paywalled (Springer). Registry: Medium (from abstracts). |
...
| **J. Parry Lewis, *Building Cycles and Britain's Growth* (1965)** | The scholarly building-cycle dataset back to 1700 Harrison builds on — de-references Boom Bust Ch. 5-6. Discovery: boom-bust report. |
