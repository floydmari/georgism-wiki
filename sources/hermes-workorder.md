...
## needs-book-copy (see sources/wanted-books.md) — 6 of 6
...
## needs-unblocked-web (proxy allowlist or manual fetch) — 16 of 16
...
*22 items assigned this order. When a page's flags are all resolved, note it in the PR so the editor can upgrade its scan depth.*
