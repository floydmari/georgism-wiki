...
- `research/nef-modern-system-fair-rents` (2026-08-12) — **closed**: the two most-cited skeptical rent-control studies were read in full from free copies this run — Autor, Palmer & Pathak on Cambridge decontrol ([NBER w18125 PDF](https://www.nber.org/system/files/working_papers/w18125/w18125.pdf)) and Diamond, McQuade & Qian on San Francisco ([Stanford PDF](https://web.stanford.edu/~diamondr/DMQ.pdf)) — and the page now reports what each finds and how it bears on NEF's "design flaw" reply. Both direct quotations and all six numeric findings were re-checked verbatim against the extracted PDF text by the orchestrator before commit. One figure produced by a fetch summary during the pass (a "5.1% citywide rent increase") was **discarded** as unlocatable in the actual paper text and does not appear on the page.
- `people/henry-george-jr` (2026-08-12) — **closed, with a correction**: the December 2, 1897 marriage no longer rests on English Wikipedia alone. Three contemporary wire-service reports (LOC *Chronicling America*: *The Evening Times* (DC) and *The Kansas City Journal*, both 1897-12-02, and *The San Francisco Call*, 1897-12-03) place the ceremony that morning at the home of the bride's father, Captain Ebenezer V. Hitch, **in Chicago** — correcting the page's prior claim that the wedding took place in Orleans Parish, Louisiana, which was in fact the Hitch family's earlier residence. The middle name "Morelle" appears in no located contemporary source and is now carried as an attributed alternative rather than asserted.
- `books/barker-henry-george-biography` (2026-08-12) — **quote audit passed, structure corrected**: all six Barker blockquotes were confirmed verbatim against the Robert Schalkenbach Foundation's complete reprint of Barker 1955 ([full text PDF](https://progressandpovertyinstitute.org/wp-content/uploads/Henry-George-Charles-Albro-Barker.pdf)), so this page did **not** share the sibling-page fabrication failure mode. Two real defects were fixed instead: the part boundary (Part One is Ch. I–X, not I–IX; Ch. X, "Before the World: *Progress and Poverty*," closes Part One, and Part Two is titled "A Christian Effort"), and a quotation boundary in the Wicksteed passage (the wiki had "fallen" inside the quotation marks; Barker's Preface places it outside). The page's arabic page citations for Preface/Contents material (pp. 11–16, 19–21, 25–26) could not be reconciled with the 1955 OUP edition's roman-numbered front matter and were replaced with Preface / Contents / chapter references — the OUP pagination remains unverified, since the RSF reprint is an unpaginated reflow and the archive.org copy is lending-restricted with no search-inside index. **Re-open only** if a page-stamped scan or physical copy becomes available and per-page citations are wanted.
