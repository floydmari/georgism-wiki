...
Fred Harrison's *The Power in the Land* treats the episode as a textbook case for the roughly 18-year land cycle, citing R. Silberberg's 1975 *Economic Record* study of Melbourne land investment returns between 1880 and 1892.[3] Harrison reports Silberberg's data as showing the average net annual rate of return on Melbourne land investment peaking at 94.8% in 1887 (Ch. 18, Table 18:I); other secondary summaries of the same Silberberg paper instead cite a weighted average return of 34.6% and a peak of 78.3% in 1887.[3] [CITATION NEEDED: direct access to Silberberg (1975), "Rates of Return on Melbourne Land Investment, 1880–92," *Economic Record* 51, pp. 203–217, to reconcile the exact peak-year figure.] Whichever precise figure is correct, both accounts agree the returns were extraordinary and concentrated around 1887–88, consistent with a classic speculative land bubble.
...
- [The Power in the Land](/wiki/harrison-power-in-the-land/)
- [Prosper Australia](/wiki/prosper-australia/)

## Sources

1. "History of Melbourne," Wikipedia, accessed July 2026. [Wikipedia](https://en.wikipedia.org/wiki/History_of_Melbourne) — used for the boom timeline, the 1887 bank-lending liberalization, the "Marvellous Melbourne" nickname, and the scale of the subsequent bank and building-society failures.
2. Reserve Bank of Australia, Research Discussion Paper 2001-07, "The 1890s Depression." [RBA](https://www.rba.gov.au/publications/rdp/2001/2001-07/1890s-depression.html) — used for the severity and dating of the depression that followed the boom's collapse.
3. Fred Harrison, *The Power in the Land*, Universe Books/Shepheard-Walwyn, 1983, Ch. 18, Table 18:I, citing R. Silberberg, "Rates of Return on Melbourne Land Investment, 1880–92," *Economic Record* 51 (1975), pp. 203–217 — used for framing the episode within the 18-year land cycle and for the disputed peak-return figure. See this wiki's page on the book: [The Power in the Land](/wiki/harrison-power-in-the-land/).

[CITATION NEEDED: a peer-reviewed economic-history source giving a single reconciled figure for the peak rate of return on Melbourne land, 1887–88, and a scholarly (rather than journalistic) account of the causal chain from the land boom to the 1893 banking crisis.]
