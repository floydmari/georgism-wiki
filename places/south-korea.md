...
5. Nam Hoon Kang (Hanshin University, Korea Inequality Research Lab), "Common Wealth Rent and Common Wealth Basic Income," presentation to the BIEN Congress 2024 (Bath, UK) — used for the Korean movement's rent-based (rather than general-revenue) framing of basic-income financing (advocacy/academic-presentation source, cited as such). **Resolved 2026-07-18:** the direct PDF was located and fetched in full; the title above corrects the page's prior paraphrase ("...and Basic Income"), and the author's name is two words per the PDF's own byline, not "Namhoon." [PDF (basicincomekorea.org)](https://basicincomekorea.org/wp-content/uploads/2024/09/BIENCongress2024_PT-by-NamhoonKANG_Common-Wealth-Rent-and-Common-Wealth-Basic-Income.pdf)
