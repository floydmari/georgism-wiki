...
- **The specific "18-year" periodicity is a later reading of Hoyt's data, not his own headline claim.** Hoyt documents a recurring cyclical pattern; the crisp ~18 (or 18.6)-year figure was extracted and popularised chiefly by later writers (Roy Wenzlick, Harrison, Foldvary, Phillip Anderson, [Akhil Patel](/wiki/akhil-patel/)), and the wiki's own [Progress and the 18.6-Year Cycle](/wiki/progress-18-6-year-cycle/) page notes this periodicity claim has not been confirmed by peer-reviewed econometric testing and remains contested.[4] Hoyt's original text is explicit on this point: "The exceptional speculative movements in land, commodities, and stocks are separated by long intervals of time, and there is no definite period of years between one boom and the next" (p. 417).[1]
