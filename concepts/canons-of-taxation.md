...
Proponents argue a [land value tax](/wiki/land-value-tax/) conforms to both lists better than any alternative (D-claim; interpretive — the Georgist reading, not a neutral verdict):

- **Lightness on production / economy.** Land's supply is fixed, so taxing its rent creates no [deadweight loss](/wiki/deadweight-loss/) and cannot be shifted onto tenants — an efficiency property held across the ideological spectrum.
...
Critics accept much of this while disputing whether land rent is a *large enough* base (see [Objection: LVT can't raise enough revenue](/wiki/lvt-not-enough-revenue/)) and whether assessment is as clean in practice as in theory.
