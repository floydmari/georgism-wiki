...
category: concepts
tags: [concepts, garden-city, ebenezer-howard, land-value-capture, rate-rent, letchworth, welwyn, community-land, town-planning, stub]
stub: true
excerpt: "The town-planning movement launched by Ebenezer Howard's Garden Cities of To-morrow (1902): planned new towns built on communally-held land, where the rising land value — Howard's 'rate-rent' — is captured for the community rather than private landlords. Letchworth (1903) and Welwyn Garden City (1920) put it into practice; a foundational land-value-capture precedent."
...
- **It captures the unearned increment for the community.** The whole design turns on the community, not private owners, receiving the rising value its own growth creates — precisely the [unearned increment](/wiki/unearned-increment/) that Georgist [land value capture](/wiki/land-value-capture/) aims to recover. Howard's "rate-rent" is a practical mechanism for doing so through communal freehold rather than through a tax.
- **It is a land-value-capture precedent, not a full LVT.** Howard captured land rent by **owning the land and leasing it** — the [public land leasing](/wiki/public-land-leasing/) / community-freehold route — rather than by taxing privately owned sites, so it sits alongside, rather than inside, the [land value tax](/wiki/land-value-tax/) family. The land case is the clean one here: the value being recaptured is site value created by community presence, exactly the surplus Georgists identify as capturable without deterring production.
- **A shared lineage with the community land trust.** The Garden City's trustee-held, permanently-communal land is a recognized forerunner of the modern [community land trust](/wiki/community-land-trust/), which likewise separates ownership of land (held in trust for the community) from the use and improvement of it. Howard himself was influenced by Henry George and by earlier land-reform and cooperative thinking.

## See Also

- [Land Value Capture](/wiki/land-value-capture/) — the general mechanism the Garden City model exemplifies
- [Community Land Trust](/wiki/community-land-trust/) — the modern institution that descends from the Garden City's trustee-held land
- [Unearned Increment](/wiki/unearned-increment/) — the rising land value the community recaptures
- [Public Land Leasing](/wiki/public-land-leasing/) — the own-and-lease route to rent capture that Howard used
- [Garden Cities of To-morrow (Howard, 1902)](/wiki/garden-cities-of-to-morrow/) — the founding book
- [Ebenezer Howard](/wiki/ebenezer-howard/) — the movement's founder

## Sources

1. Letchworth Garden City Heritage Foundation, "Our History." [letchworth.com](https://www.letchworth.com/about-us/our-history) — used for Letchworth as the world's first Garden City, Howard's 1898 book *Tomorrow: A Peaceful Path to Reform*, First Garden City Ltd beginning construction in 1903 with a commitment to repatriate all profits to the Estate, and the estate's passage to the Heritage Foundation which still manages and reinvests the property income.
2. Town and Country Planning Association / general reference (via web search), on the founding of the Garden City Association on 10 June 1899 (later the TCPA) and the sequence Letchworth (1903) and Welwyn Garden City (1920). [tcpa.org.uk](https://www.tcpa.org.uk/from-the-archive-125-years-of-the-tcpa/) · [en.wikipedia.org](https://en.wikipedia.org/wiki/Garden_city_movement) — used for the 1899 Garden City Association date and the Letchworth/Welwyn founding dates. [VERIFY: replace the Wikipedia corroboration with a primary TCPA history page for the exact 10 June 1899 first-meeting date.]
3. Ebenezer Howard, *Garden Cities of To-morrow* (1902). Project Gutenberg eBook #46134; wiki summary at [/wiki/garden-cities-of-to-morrow/](/wiki/garden-cities-of-to-morrow/). [gutenberg.org](https://www.gutenberg.org/cache/epub/46134/pg46134.txt) — used for the estate being vested in trustees who hold it in trust for the people of Garden City, all ground rents paid to the trustees and the balance handed to the municipality for public works, and Howard's definition of "rate-rent" (landlord's rent + sinking fund + rates) and his argument that the community rate-rent exceeds ordinary private rent.
