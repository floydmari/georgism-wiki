...
4. Stefania Fiorentino & Adam Moogan (2025), "The Implications of a Land Value Tax on Urban Agglomeration Dynamics: efficiency and equity," SSRN (posted 10 October 2025). [Paper](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5588585) — used for the finding that LVT can improve efficiency and equity in city formation. Title, authorship, date, and the abstract's efficiency-and-equity framing were confirmed via the SSRN listing; cited conservatively, as the wiki has read the abstract only and not the full working-paper model.
