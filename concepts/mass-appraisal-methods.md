...
- **Comparable vacant-lot sales:** where unimproved lots do sell, their prices directly indicate land value for nearby parcels. Even in extremely dense markets this can yield a usable land-value series: [Barr, Smith & Kulkarni](/wiki/barr-smith-kulkarni-manhattan-land/) built a 1950–2014 land-value index for Manhattan entirely from vacant-land sales, valuing the borough's developable land at ~$1.47 trillion in 2014.
...
A direct empirical test of these methods against real sales data comes from [Gloudemans's two Lincoln Institute working papers](/wiki/gloudemans-lvt-assessment-feasibility/) (2000, 2002), which calibrated combined vacant-and-improved-sales CAMA models on three North American residential databases. Adding vacant-land sales to a combined model barely moved predictive accuracy for improved properties (one jurisdiction's COD rose only from 5.87 to 5.97; another's actually fell from 5.75 to 5.55) while producing more plausible land/building splits than improved-sales-only models, which Gloudemans found tend to mechanically overstate land's share by absorbing buildings' fixed costs into the land term. Vacant-land CODs themselves ran higher than improved-property CODs throughout (9.55–22.96 across models and jurisdictions), consistent with the IAAO's own wider tolerance band for vacant land noted above.[16]

## An Alternative: Avoiding the Split Altogether

Rather than improving land/building separation techniques, some designs try to avoid needing the split at all. Lars Doucet's 2026 [DALT (Depreciation-Assisted Land Value Tax)](/wiki/dalt-depreciation-assisted-lvt/) proposal keeps a conventional, unified property-tax roll but fully exempts new-construction improvement value for roughly the first half of a building's expected lifetime; because depreciation is front-loaded and present value weights early-year taxes most heavily, Doucet argues this can approximate a pure LVT's incentives in fast-depreciating markets while requiring assessors to estimate only new-construction values, not a full land/building split across the existing parcel roll.[17] It is a legal- and assessment-burden workaround, not a validated substitute for the mass-appraisal methods above, and remains an untested, single-source proposal as of this writing.

## Limits and Open Questions

- **Data quality varies by jurisdiction.** CAMA systems require transaction data, structure characteristics, and geographic information; jurisdictions with poor records or few arm's-length sales face greater estimation uncertainty. Thin-data settings can substitute structured expert weighting for missing sales: [Bencure et al. (2019)](/wiki/bencure-ilvm-baybay-philippines/) built an analytic-hierarchy-process land-valuation model (iLVM) for sub-urban Baybay City, Philippines — the developing-country case Doucet cites — that explained ~67% of land-value variability and beat ordinary multiple regression on RMSE, though its expert-dependent weights transfer rather than eliminate subjective judgment. Berry (2021), regressing sale prices against assessed values in 2,628 US counties, found an average county-level r-squared of just .46 with an interquartile range of .25 to .67, concluding: "Clearly, there is variation in performance across assessors, but there is a great deal of unexplained variation in sale prices in the vast majority of jurisdictions."[11] The same study finds assessments "typically regressive," with bottom-decile homes assessed at roughly twice the ratio to sale price of top-decile homes within a jurisdiction — though this concerns whole-property assessment, the current baseline against which land assessment would be compared.[11]
...
- [DALT: Depreciation-Assisted Land Value Tax](/wiki/dalt-depreciation-assisted-lvt/) — a 2026 proposal that sidesteps the land/building split entirely rather than improving it
...
16. Robert J. Gloudemans (2000, 2002), *Implementing a Land Value Tax in Urban Residential Communities* and *An Empirical Analysis of the Incidence of Location on Land and Building Values*, Lincoln Institute of Land Policy Working Papers WP00RG1/WP02RG1 — [wiki summary, both read in full](/wiki/gloudemans-lvt-assessment-feasibility/) — used for the direct empirical COD/accuracy comparison between improved-only and combined vacant+improved CAMA models.
17. Lars Doucet (2026), "DALT: Depreciation-Assisted Land Value Tax," *Progress and Poverty* (Substack, Center for Land Economics), July 29, 2026. [Article](https://progressandpoverty.substack.com/p/dalt-depreciation-assisted-land-value) — [wiki summary](/wiki/dalt-depreciation-assisted-lvt/) — used for the DALT design as an alternative that avoids the land/building split rather than solving it.
