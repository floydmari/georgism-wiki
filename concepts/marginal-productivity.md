...
7. John Bates Clark, *The Distribution of Wealth: A Theory of Wages, Interest and Profits* (1899). Full text: [Library of Economics and Liberty](https://www.econlib.org/library/Clark/clkDW.html) — the primary edition for Clark's marginal-productivity theory (e.g. "the product of the 'final unit' of labor is the same as that of every unit"). A publicly accessible edition is now located here; the specific passages treating land as a form of capital and responding to George should be quoted from it in a future pass.

[CITATION NEEDED: direct quotations from John Bates Clark, *The Distribution of Wealth* (1899, source 7) — the specific passage(s) where land is treated as a form of capital, and any passage where Clark explicitly addresses Henry George's arguments (the econlib edition is served through a JavaScript reader that this pass could not extract cleanly).]
