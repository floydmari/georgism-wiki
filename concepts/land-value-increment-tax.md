---
title: "Land Value Increment Tax"
category: concepts
...
The **Land Value Increment Tax (LVIT)** (Chinese: 土地增值稅, *tǔdì zēngzhí shuì*) is Taiwan's tax on the *increase* in a parcel's assessed land value between transactions, capturing the [unearned increment](/wiki/unearned-increment/) at the point it is realized rather than on a recurrent basis.[1] It operates alongside a recurrent [land value tax](/wiki/land-value-tax/) as part of Taiwan's broader land-value-capture system, which the [Lincoln Institute](/wiki/lincoln-institute/) has documented as one of the most explicit national applications of Georgist land-value-capture principles.[1]
...
- **Assessed land value** is established through a government valuation process, with land valued separately from improvements — the same separation principle underlying all [site-value](/wiki/site-value/) taxation.
...
**Rate structure (progressive, current law).** Under the Land Tax Act (Article 33, in the Laws & Regulations Database of the Republic of China), the LVIT applies **regular progressive rates of 20%, 30%, and 40%**, computed bracket-by-bracket against the ratio of the increment to the base:[4]
...
- The **recurrent land value tax** captures the ongoing flow of [ground rent](/wiki/ground-rent/) annually, based on current assessed land value.
...
The LVIT is also significant as a real-world implementation of the principle — associated above all with [John Stuart Mill](/wiki/john-stuart-mill/) and developed further by Henry George — that the *future* unearned increment in land value may justly be taxed even where existing land value is left untouched. Mill's advocacy was concrete rather than merely doctrinal: the Land Tenure Reform Association he founded made taxing the "unearned increase" of land value (the programme's own Article IV wording; "unearned increment" is the later standard label) a central plank, a proposal Mill framed as reaching future increases in rent while leaving present values alone.[7] That principle was transmitted through George to Sun Yat-sen, whose equalization-of-land-rights doctrine the LVIT institutionalises as an increment tax realized at transfer. The lineage, however, remains inferential at its final link: the corpus's Mill, Sun Yat-sen, and unearned-increment pages establish it step by step, but no located source explicitly connects Mill's increment principle to the *specific design* of Taiwan's LVIT.

## See Also

- [Taiwan](/wiki/taiwan/) — the jurisdiction that implemented the LVIT at national scale
- [Sun Yat-sen](/wiki/sun-yat-sen/) — the principal intellectual source of the policy
- [Unearned Increment](/wiki/unearned-increment/) — the value the tax is designed to capture
- [Betterment Levy](/wiki/betterment-levy/) — the structurally similar UK instrument, with a history of repeal
- [The German Reich Wertzuwachssteuer (1911–1913)](/wiki/wertzuwachssteuer-germany/) — the quickly-repealed national increment tax, and the shared Kiautschou colonial root of the George→Sun→Taiwan lineage
- [Land Value Tax](/wiki/land-value-tax/) — the recurrent alternative that Taiwan operates alongside the LVIT
- [Land Value Capture](/wiki/land-value-capture/) — the broader family of instruments
- [Taiwan Land Reform (1950s)](/wiki/taiwan-land-reform-1950s/) — the policy framework that established the LVIT's foundations
- [Objection: the symmetry/decrement objection](/wiki/symmetry-decrement-objection/) — the compensation–betterment symmetry (Alterman's "pendulum" of compensation and betterment) that bears on any realized-increment tax

## Sources

1. Lincoln Institute (1998), "Policies and Mechanisms on Land Value Capture: Taiwan Case Study." [PDF](https://www.lincolninst.edu/app/uploads/legacy-files/pubfiles/144_lamtsui98.pdf) — used for the LVIT's design (tax on realized transaction-based gains), its constitutional lineage via Sun Yat-sen, its role alongside Taiwan's recurrent land value tax, and its characterization as one of the most explicit national applications of Georgist land-value-capture principles.
...
4. **Land Tax Act** (土地稅法), Republic of China (Taiwan), Laws & Regulations Database of the Republic of China — English text at [law.moj.gov.tw/ENG/…pcode=G0340096](https://law.moj.gov.tw/ENG/LawClass/LawAll.aspx?pcode=G0340096). Verified verbatim (2026-07-09). Article 33 (progressive rates 20%/30%/40% by increment bracket), Article 34 (10% self-use residence rate; 3-acre urban / 7-acre non-urban thresholds), Articles 30–31 (declared present value as tax base; review against assessed present value). Used for the current rate structure, self-use preferential rate, exemptions structure, and self-declaration mechanics; the Act's [legislative history page](https://law.moj.gov.tw/ENG/LawClass/LawHistory.aspx?pcode=G0340096) (verified 2026-07-09) is used for the 14 July 1977 promulgation date and the Article 33 amendment dates (2002, 2004, 2005).
5. **Invest Taiwan / Ministry of Economic Affairs**, "Introduction of Taiwan Tax System — Land Value Increment Tax," [investtaiwan.nat.gov.tw/showPage?lang=eng&search=68](https://investtaiwan.nat.gov.tw/showPage?lang=eng&search=68). Verified 2026-07-09. Used for the taxpayer definition, the increment-computation formula, the "regular progressive rates range from 20% to 40%," the 10% self-use residential rate, and the 20-year-plus long-term-ownership reduction.
6. Rachelle Alterman, "Is capturing the 'unearned increment' in land value still a viable idea? A cross-national analysis." [PDF (author copy, CIB conference paper)](https://www.irbnet.de/daten/iconda/CIB_DC24534.pdf) — verified 2026-07-09; an expanded version appears as "Land-Use Regulations and Property Values: The 'Windfalls Capture' Idea Revisited," in *The Oxford Handbook of Urban Economics and Planning* (2012). Used for the taxonomy separating unearned-increment capture (with Taiwan's LVIT, per Lam and Tsui 1998, among reported cases) from betterment capture, for the history of Britain's 1909–mid-1980s betterment experiments and their repeals, and for the durability conditions (trans-party rationale; link between collecting authority and revenue beneficiary).

7. **Land Tenure Reform Association** (founded at Mill's initiative), programme plank taxing the "unearned increase" of land value (Article IV of the 1871 *Programme*, reproduced in full on this wiki; the phrase "taxation of the unearned increment" is the later scholarly label). Documented in the biographical scholarship on Mill — Eugenio Biagini, *Liberty, Retrenchment and Reform* (Cambridge, 2004), and Samuel Hollander, *John Stuart Mill: Political Economist* (2015) — and summarised at [Land Tenure Reform Association](https://en.wikipedia.org/wiki/Land_Tenure_Reform_Association). Used only for the factual claim that Mill operationalised the future-unearned-increment principle through the LTRA; it does **not** connect Mill to Taiwan's LVIT. A new source for this wiki, not yet in `sources/registry.csv`.

7a. Anna Grotegut (2022), "Gegen Immobilienspekulation und steigende Mieten? / Countering Real Estate Speculation and Rising Rents?," *Jahrbuch für Wirtschaftsgeschichte / Economic History Yearbook* 63(2): 169–197. [DOI (Open Access)](https://doi.org/10.1515/jbwg-2022-0007) — see the dedicated wiki page [The German Reich Wertzuwachssteuer (1911–1913)](/wiki/wertzuwachssteuer-germany/), where the full text is read and the Kiautschou→Schrameier→Sun Yat-sen lineage is documented and graded. Used for the German Reich-level *Wertzuwachssteuer* as a comparative, quickly-repealed national land-value-increment tax: "the introduction and rapid abolition of the increment value tax on real estate in Germany between 1911 and 1913," which "neither fulfilled the land reform goal of combating speculation nor generated enough revenue."