...
The "single tax" label largely fell out of use, but the underlying policy — LVT as a major or dominant revenue source — continued to be advocated under different names. Modern Georgists typically argue for a significant land value tax rather than the wholesale replacement of all other taxes, focusing on the efficiency and equity arguments rather than the all-or-nothing framing.

## Book Findings

### Burgess: The Modern Single-Tax Case

Ronald Burgess makes a modern case for the single tax in [*Public Revenue Without Taxation*](/wiki/books/public-revenue-without-taxation/) (1993), arguing for "the abolition of all taxation and its replacement by the collection of public revenue by government as a public duty" (Burgess 1993, Ch. 10, p. 109). Burgess traces this from the Physiocrats, who "rightly emphasised the true source of injustice to be the burden of taxation" and argued that "general taxation…was a deviation from the 'natural order'" (Burgess 1993, Ch. 7, p. 75), through George, whose remedy was "simple and practical: 'abolish all taxation save that upon land values'" (Burgess 1993, Ch. 7, p. 77). (A-claim; factual)

Burgess argues that "the case argued in this work, the abolition of all taxation and its replacement by the collection of public revenue by government as a public duty, is a prerequisite for solving the major social and economic problems, including inflation and unemployment, that today appear endemic in industrialised trading economies" (Burgess 1993, Ch. 10, p. 109). He cites Colin Clark's finding that inflation becomes inevitable when government tax revenue exceeds 25% of net national product (Burgess 1993, Ch. 1, p. 2), arguing that the single tax would keep government revenue within this limit. (C-claim; theoretical) [See caveat on Clark's 25% limit on the book page.]

### Noyes: The Single Tax as Modern Synthesis

The edited volume [*Now the Synthesis*](/wiki/books/now-the-synthesis/) (1991) presents the single tax as a "synthesis" between capitalism and socialism — preserving market freedom while restoring the community's claim on economic rent. Editor Richard Noyes frames the book as articulating an "applied philosophy" for the post-Cold War era, arguing that Henry George's principle represents the emerging social synthesis observable in phenomena from UK "planning gain" to ecological tax reform (Noyes 1991, p. 13). (D-claim; interpretive)

Tideman's chapter argues that 100% land value taxation, introduced without compensation, would not be barred by the US constitutional prohibition of uncompensated takings if introduced as a constitutional rather than legislative matter — drawing an analogy to the abolition of slavery (Tideman 1991, p. 56). Busey argues that the single tax offers a "holistic philosophy" for post-socialist societies, presenting it as compatible with both market economics and social justice (Busey 1991, p. 113). (C-claim; theoretical)
...
- [Public Revenue Without Taxation](/wiki/books/public-revenue-without-taxation/) — Burgess's modern single-tax case
- [Now the Synthesis](/wiki/books/now-the-synthesis/) — Noyes's synthesis of capitalism and socialism via land reform
...
3. Charles Albro Barker, *Henry George* (New York: Oxford University Press, 1955) — used for the movement's spread and international influence (A-claims). [Book page](/wiki/books/barker-henry-george-biography/)
4. Ronald Burgess, *Public Revenue Without Taxation* (London: Shepheard-Walwyn, 1993) — used for the modern single-tax case and the Physiocratic lineage (A/C-claims). [Book page](/wiki/books/public-revenue-without-taxation/)
5. Richard Noyes (ed.), *Now the Synthesis* (London: Shepheard-Walwyn, 1991) — used for the single tax as capitalism-socialism synthesis and Tideman's constitutional argument (C/D-claims). [Book page](/wiki/books/now-the-synthesis/)
