...
- [Ecological Economics (Daly)](/wiki/books/ecological-economics-daly/) — steady-state economics and throughput limits
...
3. Herman E. Daly, *Ecological Economics and the Ecology of Economics* (Edward Elgar, 1999) — used for the steady-state economics framework, throughput limits, and the connection between ecological constraints and rent theory (C/D-claims). [Book page](/wiki/books/ecological-economics-daly/)
