...
The modern land-cycle tradition builds on this foundation with an empirical claim about timing. **[Homer Hoyt](/wiki/homer-hoyt/)**, in *One Hundred Years of Land Values in Chicago* (1933), traced Chicago land values from 1830 to 1933 and documented a recurring boom-bust rhythm in land prices.[2] **[Fred Harrison](/wiki/fred-harrison/)** revived and popularised this pattern, using it to forecast the early-1990s recession and the 2008 crash — calls made years or over a decade in advance of the events.[3] **[Fred Foldvary](/wiki/fred-foldvary/)** made a similar forecast independently in a 1997 peer-reviewed paper, writing that "the next major bust, 18 years after the 1990 downturn, will be around 2008, if there is no major interruption such as a global war."[4]
