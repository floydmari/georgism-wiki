...
category: concepts
tags: [concepts, henry-george-theorem, public-goods, stiglitz, optimal-city-size]
stub: false
excerpt: "The result that, under optimal conditions, the aggregate land rent of a community exactly equals the optimal spending on public goods — so a land tax can fund them with no other tax."
---
...
The theorem gives Georgism a rigorous foundation in mainstream theory: it is not merely that land taxation is *efficient*, but that land rent is the *natural* funding source for public goods. It connects directly to the [zero deadweight loss](/wiki/deadweight-loss/) property of land taxes.
...
- [Feldstein (1977), The Surprising Incidence of a Tax on Pure Rent](/wiki/feldstein-incidence-pure-rent/) — the strongest mainstream challenge to land-tax neutrality, showing dynamic growth-model incidence effects beyond simple landowner capitalization
- [Aldighieri: The Spatial Non-Neutrality of Land Value Taxation](/wiki/aldighieri-spatial-nonneutrality-lvt/) — a second, spatial qualification to the theorem's canonical no-distortion result
- [Moon: The Normative Case for LVT from National Defense](/wiki/moon-national-defense-lvt-normative-case/) — a normative variant of the theorem's public-goods logic applied to defense spending specifically
...
- [Giesen: FDR's Self-Financing Highways Proposal](/wiki/giesen-fdr-self-financing-highways/) — a historical US case applying, then abandoning, the theorem's self-financing-infrastructure logic
